...
\section{Processi Primari}{
    ...
    \subsection{Fornitura}{
        ...
        \subsubsection{Strumenti utilizzati}{
            ...
            \begin{itemize}
                \item \textbf{GitHub:} utilizzato per il sistema di ticketing, utile per fornire una panoramica generale delle attività previste all'intero team di progetto;
        ...
        \subsubsection{Attività di analisi dei requisiti}{
            ...
            \paragraph{Requisiti}\hfill\break{
                ...
                \begin{itemize}
                    ...
                    \item \textbf{Id} è un numero maggiore di zero, identificativo univoco di ogni requisito;
...
\section{Processi di supporto}
    ...
    \label{subsec:documentazione}
        ...
        \paragraph{Verbali}\hfill\break
            ...
            \begin{itemize}
                ...
                \end{itemize}
                \item La \textbf{tabella delle versioni} che riporta le modifiche apportate al documento, con la data, il nome dell'autore, del verificatore e una breve descrizione del cambiamento;
            ...
            \\
            Anche le attività hanno codici univoci e seguono questo formato : "Ax (x numero dell'attività)-ANNO/MESE/GIORNO\_vx".
    ...
    \label{subsubsec:prod}
        ...
        \begin{itemize}
            ...
            \item \textbf{Inizio stesura}: La creazione del documento è determinata dall'assegnatario: ogni documento è prodotto dal soggetto responsabile delle relative attività.
            \item \textbf{Verifica}: dopo la stesura il file va verificato tramite Pull Request di GitHub oppure se è un verbale va verificato direttamente su Overleaf.
        \end{itemize}
    ...
    \label{subsubsec:maint}
        È prevista la manutenzione della documentazione quando occorre apportare cambiamenti o aggiornamenti ai contenuti. Per fare la modifica si seguono i seguenti passi: 
        \begin{enumerate}
           ...
           \item Aprire una Pull Request per consentire la verifica della qualità e della correttezza del documento;
    ...
    \subsection{Gestione delle configurazioni}
        ...
        \subsubsection{Valutazione della configurazione}
            ...
            \href{https://atlasteam9.github.io/Atlas/docs/RTB/documenti/esterni/Analisi dei Requisiti.pdf}{Analisi dei Requisiti}.
    ...
    \subsection{Accertamento della qualità}
        ...
        Le metriche individuate dal team di progetto sono descritte in modo dettagliato sia nel documento \href{https://atlasteam9.github.io/Atlas/docs/RTB/documenti/esterni/Piano_di_Qualifica.pdf}{Piano di Qualifica} sia nelle sezioni~\ref{sec:mpc} e \ref{sec:mpd} del documento attuale.
        ...
        \subsubsection{Coordinamento e comunicazioni}
            ...
            \paragraph{Comunicazioni Interne}\hfill\break{
                ...
                \begin{itemize}
                    ...
                    \item \textbf{Comunicazioni sincrone (Riunioni)}: per le discussioni complesse, le sessioni di brainstorming e il coordinamento settimanale. Viene utilizzato Discord, che permette comunicazione vocale e condivisione dello schermo, facilitando il lavoro collaborativo.
                \end{itemize}
            }
    ...
    \subsection{Processi organizzativi}
        ...
        \subsubsection{Gestione dei processi}
            ...
            \begin{tabularx}{\textwidth}{|l|X|}
                ...
                \hline
                \textbf{Descrizione} & L'indice \textbf{Time Efficiency} rappresenta la percentuale delle ore che sono risultate effettivamente produttive (a discapito delle ore utilizzate per la palestra personale). \\
                \hline
            \end{tabularx}      
    ...
    \subsection{Funzionalità}
        ...
        {\renewcommand{\arraystretch}{1.4}
            ...
            \begin{tabularx}{\textwidth}{|l|X|}
                \hline
                \rowcolor{gold}
                \multicolumn{2}{|c|}{\textbf{Condition Coverage}}\\
                \hline
                \textbf{Codice} & MPD06 \\
                \hline
                \raisebox{0.6\height}{\textbf{Formula}} &  \rule{0pt}{5ex}\raisebox{0.3\height}{\( \displaystyle \text{Condition Coverage} = \frac{\text{Condizioni eseguite}}{\text{Condizioni totali}}*100 \)}\\
                \hline
                \textbf{Descrizione} & La metrica \textbf{Condition Coverage} rappresenta la percentuale di condizioni eseguite, sul totale di condizioni presenti, che assume almeno una volta entrambi i valori di verità in un test dedicato.\\
                \hline
            \end{tabularx}      
            \caption{Descrizione della metrica "Condition Coverage"}
            \end{table}
        }
