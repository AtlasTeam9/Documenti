...
\newcommand{\DataUltimaModifica}{da scrivere alla fine}
\newcommand{\LogoGruppo}{../../../Assets/AtlasLogo.png}

% --- Nuove variabili aggiunte ---
\newcommand{\VersioneDocumento}{da scrivere alla fine}
...
\section*{Registro delle modifiche}{
    ...
    \rowcolors{2}{lightblue}{white} % Alternanza automatica dal secondo row
        \begin{tabularx}{\textwidth}{|l|l|l|l|X|}
            ...
            \hline
            v0.7.2 & 2025/12/31 & Bilal Sabic & Giacomo Giora & Fine stesura sez. 5\\
            \hline
            v0.7.1 & 2025/12/30 & Federico Simonetto & Giacomo Giora & Correzioni sez. 3\\
            \hline
            v0.7.0 & 2025/12/29 & Federico Simonetto & Giacomo Giora & Stesura sez. 6 \\
            \hline
            v0.6.0 & 2025/12/29 & Bilal Sabic & Giacomo Giora & Inizio stesura sez. 5\\
            \hline
            v0.5.3 & 2025/12/29 & Federico Simonetto & Giacomo Giora & Fine stesura sez. 3\\
            \hline
            v0.5.2 & 2025/12/29 & Giacomo Giora & Federico Simonetto & Fine stesura sez. 4\\
            \hline
            v0.5.1 & 2025/12/24 & Federico Simonetto & Giacomo Giora & Fine stesura sottosez. 3.2\\
            \hline
            v0.5.0 & 2025/12/24 & Giacomo Giora & Federico Simonetto & Inizio stesura sez. 4 \\
            \hline
            v0.4.0 & 2025/12/23 & Federico Simonetto & Giacomo Giora & Inizio stesura sottosez. 3.2 e correzione errori \\
            \hline
            v0.3.1 & 2025/12/12 & Federico Simonetto & Riccardo Valerio & Fine stesura sez. 2 \\
            \hline
    ...
    \label{subsec:sviluppo}{
        ...
        \subsubsection{Attività di analisi dei requisiti}{
            ...
            \paragraph{Casi d'uso}\hfill\break{
                I casi d'uso sono identificati secondo il seguente formato: \textbf{UC-Principale.Alternativo}\newline
                dove:
                \begin{itemize}
                    \item \textbf{UC} è la sigla di Use Case, ovvero Caso d'Uso;
                    \item \textbf{Principale} è rappresentato da un numero maggiore di zero e indica che il Caso d'Uso attuale non è correlato ad altri casi d'uso. Il numero indicato dal campo \textbf{Principale} è univoco tra tutti i Casi d'Uso;
...
\section{Processi di supporto}
    ...
    \label{subsec:documentazione}
        ...
        \paragraph{Verbali}\hfill\break
            ...
            \end{itemize}
            Ogni decisione ha un suo codice univoco e segue questo formato : "Dx (x numero della decisione)-ANNO/MESE/GIORNO\_vi" ("vi" se interno, "ve" se esterno).
            \\
    ...
    \label{subsubsec:prod}
        ...
        \end{itemize}
        Dopo la verifica, il responsabile approva la Pull Request, e il file viene integrato nel branch principale. Successivamente, il sistema automatizzato \textbf{GitHub Actions} provvede a inserire il file nella cartella corretta del sito web.
    ...
    \subsection{Gestione delle configurazioni}
        ...
        \subsubsection{Strumenti utilizzati}
            ...
            \begin{itemize}
                \item \textbf{GitHub:} per gestire creazione, modifiche e release di documenti e codice. Oltre a gestire il versionamento, GitHub permette anche l'assegnazione dei compiti e il loro tracciamento.
            \end{itemize}
        ...
        \subsubsection{Identificazione della configurazione}
            L'attività di identificazione della configurazione riveste un ruolo essenziale nel progetto didattico. Essa prevede una descrizione accurata degli elementi software che compongono il sistema, svolta dai progettisti e formalizzata nel documento \textit{Specifica tecnica}. Tale documento viene redatto successivamente al raggiungimento della \textit{Requirements and Technology Baseline} e reso disponibile in vista della definizione della \textit{Product Baseline}.
        

        \subsubsection{Controllo della configurazione}
            Il team ha deciso di utilizzare i seguenti strumenti messi a disposizione dalla piattaforma GitHub per svolgere tale attività:
            \begin{itemize}
            ...
            Le \textbf{Pull Request} sono richieste effettuate da un membro del team per proporre l'operazione di merge tra due branch differenti. Ogni Pull Request deve essere approvata dai verificatori prima di poter essere integrata nel branch principale, riducendo così la probabilità di introdurre errori nel codice o nella documentazione.
            ...
            \begin{itemize}
                \item è identificata su GitHub tramite la notazione \textbf{\#NUMERO}, dove \textbf{NUMERO} rappresenta un identificativo univoco all'interno del repository;
                \item fa riferimento a una e una sola milestone di progetto e a una Project Board, entrambe appartenenti allo stesso repository della issue;
                ...
                \item viene chiusa quando il documento o il componente software a cui la issue fa riferimento viene integrato (merge) nel branch principale.
            \end{itemize}


            \paragraph{Project Board}\hfill\break
                La \textbf{Project Board} viene utilizzata per migliorare l'organizzazione del lavoro asincrono svolto dal team. Ogni issue creata viene inizialmente inserita nella sezione \textit{Backlog} della Project Board, relativa allo sprint in corso. Quando un membro del team prende in carico una issue, questa viene spostata nella sezione \textit{In progress}. Al termine dell'attività, e contestualmente all'apertura della relativa Pull Request, la issue viene collocata nella sezione \textit{In review}, in attesa della verifica da parte dei verificatori. Una volta approvata la Pull Request e completata l'operazione di merge, la issue viene spostata nella sezione \textit{Done} e contrassegnata come chiusa.
            
        

        \subsubsection{Rendicontazione dello stato della configurazione}
            L'attività di rendicontazione dello stato della configurazione viene effettuata mediante il seguente sistema di versionamento: \textbf{MAJOR.MINOR.PATCH}, dove:
            \begin{itemize}
                \item la cifra \textbf{PATCH} viene incrementata in caso di modifiche di lieve entità al codice o alla documentazione, quali, ad esempio, la correzione di errori ortografici;
            ...
            Tale sistema di versionamento è stato adottato dal team tramite la decisione
            \href{https://atlasteam9.github.io/Atlas/docs/RTB/verbali/interni/VI-2025-11-07.pdf}{D2-2025/11/07\_vi}.
        ...
        \subsubsection{Valutazione della configurazione}
            ...
            \href{https://atlasteam9.github.io/Atlas/docs/RTB/documenti/esterni}{Analisi dei Requisiti TODO:LINK!!!!}.
    ...
    \subsection{Accertamento della qualità}
        Il processo di accertamento della qualità ha lo scopo di fornire adeguate garanzie che il prodotto software, i processi di sviluppo e la documentazione associata siano conformi ai requisiti specificati, agli standard adottati e alle pianificazioni stabilite.
        ...
        Le metriche individuate dal team di progetto sono descritte in modo dettagliato sia nel documento \href{LINK}{Piano di Qualifica TODO:LINK!!!!} sia nella sez. DA SCRIVERE E METTERE LINK.
        %~\ref{sezione dedicata TODO:DA SCRIVERE!!!!!}
    ...
    \subsection{Verifica}
        Il processo di verifica ha lo scopo di determinare se il prodotto software sviluppato sia conforme ai requisiti specificati e alle condizioni imposte. Al fine di ridurre i costi e massimizzare l'efficienza, tale processo viene integrato il più precocemente possibile all'interno del ciclo di vita del software, accompagnando le attività di sviluppo.

        \subsubsection{Strumenti utilizzati}
            Per garantire lo svolgimento delle attività previste, il team utilizza:
            \begin{itemize}
                \item \textbf{GitHub:} per la gestione del sistema di Pull Request (descritto nella sottosezione~\ref{par:pullrequest}), impiegato per supportare l'attività di verifica dei documenti.
            \end{itemize}    
        ...
        \subsubsection{Verifica}
            L'attività di verifica della documentazione avviene tramite il sistema di Pull Request, descritto nelle sottosezioni ~\ref{subsubsec:prod} e~\ref{subsubsec:maint}.
            \newline
            Le modalità di verifica del codice, invece, verranno definite successivamente, a Requirement and Technology Baseline inoltrata, poiché sarà in quel momento che il team avrà necessità di approfondire tale argomento.
            ...
            \paragraph{Analisi dinamica}\hfill\break
                ...
                I test svolti dal team, durante lo svolgimento del progetto didattico verranno identificati mediante il seguente formato:
                TODO: DA DEFINIRE NEL PdQ!!!!!!!!!!!!!
                ...
                \subparagraph{Test di unità}\hfill\break
                    ...
                    L'obiettivo principale dei test d'unità è verificare che ciascuna unità produca i risultati attesi a fronte di input noti, individuando eventuali errori logici o di implementazione nelle prime fasi dello sviluppo.
                ...
                \subparagraph{Test di accettazione}\hfill\break
                    I test di accettazione verificano che l'esecuzione del sistema soddisfi tutti i requisiti lato utente, definiti nel capitolato di presentazione.


    \subsection{Validazione}
       Il processo di validazione ha lo scopo di determinare se i requisiti definiti e il prodotto software finale soddisfino lo specifico uso inteso, così come concordato con gli utenti e gli stakeholder. In sintesi, il processo di validazione fornisce evidenza oggettiva della correttezza del prodotto dal punto di vista dell'utente finale, garantendo l'allineamento tra requisiti, implementazione e contesto operativo reale.

        \subsubsection{Attività previste}
            \begin{enumerate}
                \item \textbf{Implementazione del processo:} definizione e predisposizione del piano di validazione, in accordo con gli standard utilizzati, al fine di stabilire criteri, metodi, responsabilità e risorse necessarie. Tale attività è finalizzata all'individuazione di eventuali non conformità rispetto ai requisiti e agli standard adottati, nonché alla pianificazione delle relative azioni correttive;
                \item \textbf{Validazione:} esecuzione delle attività di validazione previste dal piano, attraverso test, revisioni e valutazioni del prodotto software nel suo contesto di utilizzo. I risultati ottenuti vengono documentati e analizzati per verificare la soddisfazione dei requisiti utente e per supportare il processo di accettazione del prodotto.
            \end{enumerate}    
...
\section{Processi Organizzativi}
    ...
    Con lo scopo di garantire qualità, efficienza e sostenibilità lungo l'intero ciclo di vita del software, tra i processi organizzativi si individuano:
    \begin{itemize}
    ...
    \subsection{Gestione dei Processi}
        Come previsto dallo Standard ISO/IEC 12207:1995, il processo organizzativo di gestione dei processi ha l'obiettivo di individuare le attività generali che ciascun membro del team è tenuto a svolgere. Si tratta di un'attività fondamentale per assicurare che il progetto venga portato a termine in modo efficiente e nel rispetto degli standard di qualità definiti.
        ...
        \subsubsection{Attività previste}
            ...
            \begin{itemize}
                ...
                \item \textbf{Pianificazione}: stima di tempi, costi e assegnazione dei compiti nel \textit{Piano di Progetto};
        ...
        \subsubsection{Ruoli e responsabilità}
            ...
            \paragraph{Amministratore}\hfill\break{
                L'Amministratore ha il compito fondamentale di gestire e mantenere l'infrastruttura tecnologica necessaria allo sviluppo, assicurandone l'efficienza e la sicurezza. È responsabile della gestione delle configurazioni, del versionamento del codice e della documentazione, nonché dell'implementazione di automazioni per ottimizzare il Way of Working. Supervisiona inoltre la corretta applicazione delle norme di progetto e la risoluzione di eventuali malfunzionamenti degli strumenti di supporto.
            }

            \paragraph{Analista}\hfill\break{
                Questo ruolo è cruciale nelle fasi iniziali per trasformare i bisogni del proponente in requisiti tecnici dettagliati e non ambigui. L'Analista studia il dominio del problema, individua i casi d'uso e redige il documento di \textit{Analisi dei Requisiti}, che funge da base solida per tutta la progettazione successiva. Deve assicurarsi che ogni requisito (funzionale, di qualità o di vincolo) sia chiaramente definito per evitare errori che comprometterebbero l'intero progetto.
            }

            \paragraph{Progettista}\hfill\break{
                Al Progettista spetta il compito di trasformare i requisiti in una struttura architetturale solida e scalabile. Effettua le scelte tecnologiche relative a framework e librerie, definisce l'interazione tra i componenti del sistema e produce i diagrammi UML (come i diagrammi delle classi) necessari alla codifica. Il suo obiettivo è garantire un basso accoppiamento tra i moduli e un'alta manutenibilità del prodotto finale.
            }

            \paragraph{Programmatore}\hfill\break{
                Il Programmatore è responsabile dello sviluppo attivo del software, traducendo le specifiche tecniche e architetturali in codice sorgente funzionante. Deve rispettare rigorosamente gli standard di Clean Code e le convenzioni linguistiche stabilite. Oltre alla scrittura del codice, ha il compito di realizzare i test di unità automatici e di collaborare alla redazione del \textit{Manuale Utente} per l'utilizzatore finale.
            }
        ...
        \subsubsection{Coordinamento e comunicazioni}
            ...
            \paragraph{Comunicazioni Interne}\hfill\break{
                ...
                \begin{itemize}
                    ...
                    \item \textbf{Comunicazioni sincrone (Riunioni)}: per le discussioni complesse, le sessioni di brainstorming e il coordinamento settimanale. si utilizza Discord, che permette comunicazione vocale e condivisione dello schermo, facilitando il lavoro collaborativo.
                \end{itemize}
            }

            \paragraph{Comunicazioni Esterne}\hfill\break{
                Le comunicazioni esterne sono gestite dal Responsabile e  riguardano il rapporto con proponente e committente. Si distinguono in tre categorie:
                \begin{itemize}
                    ...
                    \item \textbf{Comunicazioni formali}: per richieste ufficiali o invio di documenti, il Responsabile utilizza esclusivamente la posta elettronica del team, avente il seguente indirizzo: \Email.
            ...
            \paragraph{Verbali}\hfill\break{
                Ogni incontro sincrono, interno o esterno, deve essere documentato tramite un verbale redatto dal Responsabile e verificato dal Verificatore stabilito. I verbali esterni, una volta redatti e giunti alla versione stabile v1.0.0, vengono inviati al proponente per l'approvazione e la firma.
            }

        \subsubsection{Gestione delle attività}
            L'obiettivo di questo processo è garantire un'organizzazione efficiente del lavoro durante il progetto. In questa sezione viene descritto il metodo di lavoro che permette al team di organizzare i compiti, monitorare l'avanzamento e garantire il rispetto delle scadenze.

            \paragraph{Metodologia di lavoro}\hfill\break{
                Il team adotta un approccio \textbf{Agile} allo sviluppo per garantire  flessibilità, maggiore produttività e una comunicazione trasparente sia internamente che verso gli Stakeholder. Il lavoro viene organizzato in cicli iterativi definiti Sprint, solitamente di durata bisettimanale, che permettono una scomposizione modulare delle attività e una pianificazione accurata basata su obiettivi misurabili. Le principali pratiche adottate dal gruppo includono:
                \begin{itemize}
            ...
            \paragraph{Strumenti di Ticketing}\hfill\break{
                ...
                \begin{itemize}
                    ...
                    \item \textbf{Assegnatario}: il membro del team responsabile dello svolgimento.
                    \item \textbf{Etichette (Labels)}: per categorizzare la natura del task (es. bug, documentation, feature).
                    \item \textbf{Project}: il GitHub Project a cui la issue è associata.
                    \item \textbf{Milestone}: il traguardo o la revisione di progetto a cui il task è associato.
                \end{itemize}
            }
            ...
            \paragraph{Workflow di un Task}\hfill\break{
                ...
                \begin{itemize}
                    \item \textbf{Creazione della Issue}: il Responsabile (o l'Amministratore) apre l'Issue e la assegna.
                    ...
                    \item \textbf{Sviluppo}: l'assegnatario sposta il task in "In Progress" e lavora sulle sotto-issue su un branch dedicato nel repository.
                    \item \textbf{Pull Request}: al termine del lavoro, viene aperta una Pull Request (PR) collegata all'Issue principale, la issue passa allo stato "In review".
                    \item \textbf{Verifica}: il Verificatore esamina la PR. Se l'esito è positivo, effettua il merge; in caso contrario, richiede modifiche tramite commenti, e la issue torna nello stato "In Progress" fino alla correzione.
                    \item \textbf{Chiusura}: una volta effettuato il merge, la Issue passa automaticamente in "Done" e il branch di lavoro viene eliminato.
                \end{itemize}
            }

    \subsection{Gestione delle infrastrutture}
        La gestione delle infrastrutture ha l'obiettivo di definire tutti gli strumenti, gli ambienti e le risorse tecnologiche necessarie per garantire l'efficienza dei processi primari e di supporto. Questo processo permette al team di lavorare in modo stabile e sicuro, evitando interruzioni dovute a problemi tecnici o carenze di configurazione.
        ...
        \subsubsection{Attività previste}
            ...
            \begin{itemize}
                ...
                \item \textbf{Realizzazione dell'infrastruttura}: configurazione operativa degli ambienti di sviluppo, dei server e dei canali di comunicazione.
        ...
        \subsubsection{Strumenti di supporto}
            ...
            \begin{itemize}
                \item \textbf{Sviluppo e Containerizzazione}: Git è impiegato come sistema di controllo di versione per monitorare e gestire le modifiche al codice. Docker viene utilizzato per creare ambienti isolati, garantendo che l'applicazione funzioni correttamente in modo indipendente dalla macchina locale.
                \item \textbf{Hosting e Collaborazione}: GitHub funge da piattaforma di hosting per i repository remoti e consente di organizzare e seguire il backlog tramite Issue e Project Board.
                ...
                \item \textbf{Pianificazione e Documentazione}: Google Calendar è utilizzato per la gestione di appuntamenti e scadenze, mentre LaTeX rappresenta lo standard per la redazione tipografica della documentazione tecnica.
        ...
        \subsubsection{Gestione repository}
            Si adotta un modello ispirato a GitHub Flow e semplificato rispetto al Git Flow tradizionale, in modo da avere un workflow leggero basato sui seguenti principi:
            \begin{itemize}
                \item \textbf{Branching}: il branch \textit{main} contiene esclusivamente codice stabile e verificato, e documenti definitivi che vengono esposti nel \href{https://atlasteam9.github.io/Atlas/}{sito web del team}. Ogni nuova funzionalità o correzione di bug deve essere sviluppata in un branch dedicato creato a partire dal ramo di sviluppo chiamato \textit{develop}, che deriva da \textit{main}, contiene i nuovi documenti e il codice su cui il team sta lavorando. 
                \item \textbf{Nomenclatura branch}: i nuovi rami devono seguire uno schema identificativo ben definito:
                \begin{itemize}
                    \item se il lavoro riguarda la stesura di un documento, il branch deve avere il nome docs/nome-documento;
                    \item se il lavoro riguarda la stesura di codice, il branch deve avere il nome feature/nome-feature;
                    \item se il lavoro riguarda la correzione di bug, il branch deve avere il nome bugfix/nome-bugfix.
                \end{itemize}
                \item \textbf{Integrazione}: l'unione del codice nel ramo principale avviene esclusivamente tramite Pull Request. Queste devono essere revisionate e approvate da almeno un Verificatore prima del merge.
                \item \textbf{Automazione (CI/CD)}: sono configurate delle GitHub Actions per automatizzare compiti ripetitivi, come la compilazione della documentazione Latex in PDF e la sua pubblicazione sul sito vetrina del progetto.
            \end{itemize}

    \subsection{Miglioramento del processo}
        Il processo di miglioramento ha l'obiettivo di individuare punti deboli nell'organizzazione del lavoro e ottimizzare il Way of Working del team nel corso del progetto. Si tratta di un ciclo continuo che accompagna tutte le fasi di sviluppo e gestione, e consente di stabilire, misurare e migliorare gli standard operativi adottati durante il ciclo di vita del software.

        \subsubsection{Attività previste}
        Il processo si articola in tre attività principali:
            \begin{itemize}
                \item \textbf{Inizializzazione dei processi}: definizione e formalizzazione dei processi organizzativi, con relativa documentazione nelle Norme di Progetto.
                \item \textbf{Valutazione dei processi}: verifica periodica dell'efficacia dei processi tramite analisi di metriche, dati storici e risultati ottenuti.
        ...
        Lo strumento principale per identificare le opportunità di miglioramento è la Sprint Retrospective. Al termine di ogni iterazione, il gruppo analizza ciò che ha funzionato e ciò che deve essere cambiato, attuando azioni correttive immediate per evitare di ripetere errori passati.
        
    \subsection{Formazione del personale}
        Il processo di formazione ha lo scopo di garantire che ogni membro del team acquisisca le competenze tecniche e metodologiche necessarie per svolgere il proprio ruolo in modo efficace ed efficiente. L'obiettivo è mantenere il gruppo costantemente aggiornato e allineato sulle tecnologie scelte e sugli standard di qualità prefissati, favorendo al contempo la crescita professionale durante lo svolgimento del progetto. La formazione può riguardare tecnologie, metodologie di sviluppo, strumenti di collaborazione o aspetti organizzativi interni.
        ...
        \subsubsection{Piano di formazione e tempistiche di esecuzione}
            ...
            \begin{itemize}
                ...
                \item pianificare, se necessario, slot temporali dedicati esclusivamente all'approfondimento delle tecnologie necessarie come il linguaggio Python, la libreria React, la containerizzazione con Docker o l'uso di Latex per la documentazione.
            \end{itemize}  
...
\begin{itemize}
    ...
    \item \textbf{Recuperabilità}: la capacità del software di ripristinare le prestazioni desiderate dopo che si è verificato un errore.
    \item \textbf{Aderenza}: la capacità di aderire a standard, regole e convenzioni inerenti all'affidabilità.
\end{itemize}
\subsection{Efficienza}
L'efficienza è la capacità di fornire appropriate prestazioni relativamente alla quantità di risorse usate. Le sue sotto-caratteristiche sono:
\begin{itemize}
...
L'usabilità è la capacità del software di essere compreso, appreso e utilizzato dall'utente in condizioni specifiche. Le sue sotto-caratteristiche sono:
\begin{itemize}
...
La portabilità è la capacità del software di essere trasportato da un ambiente di lavoro ad un altro. Le sue sotto-caratteristiche sono:
\begin{itemize}
    \item \textbf{Adattabilità}: la capacità del software di adattarsi a diversi ambienti senza richiedere modifiche significative al codice sorgente o all'architettura.
    ...
    \subsection{Processi primari}
        \subsubsection{Fornitura}
            ...
            \begin{tabularx}{\textwidth}{|l|X|}
                \hline
                \rowcolor{gold}
                \multicolumn{2}{|c|}{\textbf{Variance at Completion (VAC)}}\\
                \hline
                \textbf{Codice} & MPC11\\
                \hline
                \textbf{Formula} & \( \displaystyle \text{VAC} = \text{BAC}-\text{EAC} \)\\
                \hline
                \textbf{Descrizione} & Il \textbf{VAC} misura la differenza in budget originario del progetto (BAC) e quello stimato per il completamento del progetto (EAC). \\
                \hline
            \end{tabularx}      
            \caption{Descrizione della metrica "Variance at Completion"}
            \end{table}
            }
    ...
    \subsection{Processi organizzativi}
        ...
        \subsubsection{Gestione dei processi}
            ...
            \begin{tabularx}{\textwidth}{|l|X|}
                \hline
                \rowcolor{gold}
                \multicolumn{2}{|c|}{\textbf{Time Efficiency}}\\
                \hline
                \textbf{Codice} & MPC19\\
                \hline
                \raisebox{0.6\height}{\textbf{Formula}} &  \rule{0pt}{5ex}\raisebox{0.3\height}{\( \displaystyle \text{Time Efficiency} = \left(\frac{\text{Numero di ore produttive}}{\text{Numero di ore totali}}\right)*100 \)}\\
                \hline
                \textbf{Descrizione} & L'indice \textbf{Time Efficiency} rappresenta la percentuale delle ore le quali sono risultate effettivamente produttive (a discapito delle ore utilizzate per la palestra personale). \\
                \hline
            \end{tabularx}      
            \caption{Descrizione della metrica "Time Efficiency"}
            \end{table}
            }
