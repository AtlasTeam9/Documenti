...
\newcommand{\DataUltimaModifica}{2026/03/14}
...
\section*{Registro delle modifiche}
    ...
    \rowcolors{2}{lightblue}{white} % Alternanza automatica dal secondo row
        \begin{tabularx}{\textwidth}{|l|l|l|l|X|}
            ...
            \hline
            \VersioneDocumento & \DataUltimaModifica & Francesco Marcolongo & Federico Simonetto & Sostituiti indici del glossario con le lettere\\
            \hline
            v1.0.0 & 2026/02/09 & Francesco Marcolongo & Giacomo Giora & Approvazione documento\\
            \hline
