...
\newcommand{\DataUltimaModifica}{2026/01/13}
\newcommand{\LogoGruppo}{../../../Assets/AtlasLogo.png} 

% --- Nuove variabili aggiunte ---
\newcommand{\VersioneDocumento}{v0.9.0} % <-- modifica qui la versione o ID
...
\section*{Registro delle modifiche}
    ...
    \rowcolors{2}{lightblue}{white} 
        \begin{tabularx}{\textwidth}{|l|l|l|X|X|}
            ...
            \hline
            \VersioneDocumento & \DataUltimaModifica & Michele Tesser & Andrea Difino & Completati requisiti funzionali \\
            \hline
