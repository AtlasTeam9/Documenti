...
\newcommand{\VersioneDocumento}{v0.11.0} % <-- modifica qui la versione o ID
...
\section*{Registro delle modifiche}
    ...
    \rowcolors{2}{lightblue}{white} 
        \begin{tabularx}{\textwidth}{|l|l|l|X|X|}
            ...
            \hline
            \VersioneDocumento & \DataUltimaModifica & Michele Tesser & Andrea Difino & Prima stesura requisiti di vincolo \\
            \hline
