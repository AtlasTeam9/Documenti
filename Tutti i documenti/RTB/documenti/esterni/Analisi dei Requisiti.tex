...
\newcommand{\DataUltimaModifica}{2026/01/08}
\newcommand{\LogoGruppo}{../../../Assets/AtlasLogo.png} 

% --- Nuove variabili aggiunte ---
\newcommand{\VersioneDocumento}{v0.8.1} % <-- modifica qui la versione o ID
...
\section*{Registro delle modifiche}
    ...
    \rowcolors{2}{lightblue}{white} 
        \begin{tabularx}{\textwidth}{|l|l|l|X|X|}
            ...
            \hline
            \VersioneDocumento & \DataUltimaModifica & Riccardo Valerio & Andrea Difino & Iniziati requisiti funzionali da 1 a 13 \\
            \hline
    ...
    \subsection{Requisiti funzionali}{
        ...
        \rowcolors{2}{lightblue}{white}
            \begin{tabularx}{\textwidth}{|l|X|l|}
                ...
                \hline
                R-13-F-Ob & L'Utente deve poter salvare le modifiche apportate alla lista degli asset creata manualmente & \hyperref[uc:uc6]{UC6}\\
                \hline
            \end{tabularx}
