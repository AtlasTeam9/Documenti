...
\newcommand{\VersioneDocumento}{v0.15.0} % <-- modifica qui la versione o ID
...
\section*{Registro delle modifiche}
    ...
    \rowcolors{2}{lightblue}{white} 
        \begin{tabularx}{\textwidth}{|l|l|l|X|X|}
            ...
            \hline
            \VersioneDocumento & \DataUltimaModifica & Riccardo Valerio & Giacomo Giora & Completati requisiti \\
            \hline
    ...
    \subsection{Elenco Casi d'Uso}{
        ...
        \end{itemize}
            ...
            \begin{itemize}
                \item \textbf{Attore}: Utente
                \item \textbf{Pre-condizioni}: Il Sistema si trova allo stato iniziale 
                \item \textbf{Post-condizioni}: Il test selezionato dall'utente é stato caricato nel Sistema 
                \item \textbf{Scenario principale}:
                \begin{itemize}
...
\section{Requisiti}{
    ...
    \subsection{Requisiti funzionali}{
            \rowcolors{2}{lightblue}{white}
                ...
                R-3-F-Ob & L'Utente deve poter ricevere un errore in seguito ad un tentativo di caricamento di un file non valido & \hyperref[uc:uc3]{UC3} \\ \hline
                ...
                R-28-F-Ob & L'Utente, nel processo di inserimento dei dati del dispositivo, deve poter visualizzare un errore se inserisce in uno o più campi dei valori non validi & \hyperref[uc:uc13]{UC13} \\ \hline
                ...
                R-34-F-Ob & L'Utente, nel processo di creazione di un asset, deve poter visualizzare un errore se inserisce in uno o più campi dei valori non validi & \hyperref[uc:uc13]{UC13} \\ \hline
                ...
                R-43-F-Op & L'Utente, nel processo di modifica di un asset, deve poter visualizzare un errore se inserisce in uno o più campi dei valori non validi & \hyperref[uc:uc13]{UC13} \\ \hline
                R-44-F-Op & L'Utente deve poter annullare il processo di modifica di un asset & \hyperref[uc:uc18]{UC18} \\ \hline
                R-45-F-Ob & L'Utente deve poter visualizzare un avviso che indica la presenza di modifiche non salvate se ha creato un dispositivo o ha apportato modifiche ad un dispositivo esistente & \hyperref[uc:uc19]{UC19} \\ \hline
                R-46-F-Ob & L'Utente deve poter effettuare il salvataggio delle modifiche non salvate quando visualizza l'avviso che indica la presenza di modifiche non salvate & \hyperref[uc:uc20]{UC20}, \hyperref[uc:uc21]{UC21}\\ \hline
                ...
                R-48-F-Ob & L'Utente, nel visualizzare le informazioni di dettaglio di un asset, deve poter visualizzare il nome dell'asset & \hyperref[uc:uc22.1]{UC22.1} \\ \hline
                R-49-F-Ob & L'Utente, nel visualizzare le informazioni di dettaglio di un asset, deve poter visualizzare il tipo dell'asset & \hyperref[uc:uc22.2]{UC22.2} \\ \hline
                R-50-F-Ob & L'Utente, nel visualizzare le informazioni di dettaglio di un asset, deve poter visualizzare la descrizione dell'asset & \hyperref[uc:uc22.3]{UC22.3} \\ \hline
                R-51-F-Ob & L'Utente, nel visualizzare le informazioni di dettaglio di un asset, deve poter visualizzare la sensibilità dell'asset & \hyperref[uc:uc22.4]{UC22.4} \\ \hline
                R-52-F-Ob & L'Utente deve poter visualizzare i dati del dispositivo inserito nel dettaglio & \hyperref[uc:uc23]{UC23} \\ \hline
                R-53-F-Ob & L'Utente, nel visualizzare i dati del dispositivo inserito nel dettaglio, deve poter visualizzare il nome del dispositivo & \hyperref[uc:uc23.1]{UC23.1} \\ \hline
                R-54-F-Ob & L'Utente, nel visualizzare i dati del dispositivo inserito nel dettaglio, deve poter visualizzare il sistema operativo del dispositivo & \hyperref[uc:uc23.2]{UC23.2} \\ \hline
                R-55-F-Ob & L'Utente, nel visualizzare i dati del dispositivo inserito nel dettaglio, deve poter visualizzare la versione del firmware del dispositivo & \hyperref[uc:uc23.3]{UC23.3} \\ \hline
                R-56-F-Ob & L'Utente, nel visualizzare i dati del dispositivo inserito nel dettaglio, deve poter visualizzare la funzionalità del dispositivo & \hyperref[uc:uc23.4]{UC23.4} \\ \hline
                R-57-F-Ob & L'Utente, nel visualizzare i dati del dispositivo inserito nel dettaglio, deve poter visualizzare la descrizione del dispositivo & \hyperref[uc:uc23.5]{UC23.5} \\ \hline
                ...
                R-65-F-Op & L'Utente, nel visualizzare la lista delle giustificazioni di un test, deve poter visualizzare una singola giustificazione & \hyperref[uc:uc27.1]{UC27.1} \\ \hline
                R-66-F-Op & L'Utente, nel visualizzare una singola giustificazione nella lista delle giustificazioni di un test, deve poter visualizzare il nome del requisito & \hyperref[uc:uc33.2]{UC33.2} \\ \hline
                R-67-F-Op & L'Utente, nel visualizzare una singola giustificazione nella lista delle giustificazioni di un test, deve poter visualizzare il testo della giustificazione associata al requisito & \hyperref[uc:uc27.1.1]{UC27.1.1} \\ \hline
                ...
                R-69-F-Ob & L'Utente, nel visualizzare la lista degli assets con risultati di un requisito nel dettaglio, deve poter visualizzare un singolo asset con risultato & \hyperref[uc:uc28.1]{UC28.1} \\ \hline
                R-70-F-Ob & L'Utente, nel visualizzare un singolo asset con risultato nella lista degli assets con risultati di un requisito nel dettaglio, deve poter visualizzare il nome dell'asset & \hyperref[uc:uc22.1]{UC22.1} \\ \hline
                R-71-F-Ob & L'Utente, nel visualizzare un singolo asset con risultato nella lista degli assets con risultati di un requisito nel dettaglio, deve poter visualizzare il risultato dell'asset & \hyperref[uc:uc28.1.1]{UC28.1.1} \\ \hline
                ...
                R-74-F-Op & L'Utente, nel processo di modifica dei dati di un dispositivo, deve poter modificare il nome del dispositivo & \hyperref[uc:uc30.1]{UC30.1} \\ \hline
                R-75-F-Op & L'Utente, nel processo di modifica dei dati di un dispositivo, deve poter modificare il sistema operativo del dispositivo & \hyperref[uc:uc30.2]{UC30.2} \\ \hline
                R-76-F-Op & L'Utente, nel processo di modifica dei dati di un dispositivo, deve poter modificare la versione del firmware del dispositivo & \hyperref[uc:uc30.3]{UC30.3} \\ \hline
                R-77-F-Op & L'Utente, nel processo di modifica dei dati di un dispositivo, deve poter modificare la funzionalità del dispositivo & \hyperref[uc:uc30.4]{UC30.4} \\ \hline
                R-78-F-Op & L'Utente, nel processo di modifica dei dati di un dispositivo, deve poter modificare la descrizione del dispositivo & \hyperref[uc:uc30.5]{UC30.5} \\ \hline
                ...
                R-82-F-Op & L'Utente, nel visualizzare l'elenco dei decision trees, deve poter visualizzare un singolo decision tree & \hyperref[uc:uc32.1]{UC32.1} \\ \hline
                R-83-F-Op & L'Utente deve poter visualizzare un singolo decision tree nel dettaglio selezionandolo dalla lista dei decision trees & \hyperref[uc:uc33]{UC33} \\ \hline
                R-84-F-Op & L'Utente, nel visualizzare un singolo decision tree nell'elenco dei decision trees, deve poter visualizzare l'id del requisito associato al decision tree & \hyperref[uc:uc33.1]{UC33.1} \\ \hline
                R-85-F-Op & L'Utente, nel visualizzare un singolo decision tree nell'elenco dei decision trees, deve poter visualizzare il nome del requisito associato al decision tree & \hyperref[uc:uc33.2]{UC33.2} \\ \hline
                R-86-F-Op & L'Utente, nel visualizzare un singolo decision tree nel dettaglio, deve poter visualizzare le dipendenze del requisito associato al decision tree & \hyperref[uc:uc33.3]{UC33.3} \\ \hline
                R-87-F-Op & L'Utente, nel visualizzare un singolo decision tree nel dettaglio, deve poter visualizzare il grafo che rappresenta il decision tree & \hyperref[uc:uc33.4]{UC33.4} \\ \hline
                R-88-F-Op & L'Utente, nel visualizzare il grafo che rappresenta un decision tree, deve poter visualizzare i nodi interni del grafo & \hyperref[uc:uc33.4.1]{UC33.4.1} \\ \hline
                R-89-F-Op & L'Utente, nel visualizzare un nodo interno del grafo che rappresenta un decision tree, deve poter visualizzare il codice univoco del nodo &  \hyperref[uc:uc33.4.1.1]{UC33.4.1.1} \\ \hline
                R-90-F-Op & L'Utente, nel visualizzare un nodo interno del grafo che rappresenta un decision tree, deve poter visualizzare il testo della domanda del nodo & \hyperref[uc:uc33.4.1.2]{UC33.4.1.2}  \\ \hline
                R-91-F-Op & L'Utente, nel visualizzare il grafo che rappresenta un decision tree, deve poter visualizzare i nodi foglia del grafo & \hyperref[uc:uc33.4.2]{UC33.4.2} \\ \hline
                R-92-F-Op & L'Utente, nel visualizzare il grafo che rappresenta un decision tree, deve poter visualizzare i collegamenti fra i nodi del grafo & \hyperref[uc:uc33.4.3]{UC33.4.3} \\ \hline
                R-93-F-Op & L'Utente deve poter modificare un decision tree & \hyperref[uc:uc34]{UC34} \\ \hline
                R-94-F-Op & L'Utente, per modificare un decision tree, deve poter aggiungere un nodo al decision tree & \hyperref[uc:uc35]{UC35} \\ \hline
                R-95-F-Op & L'Utente, nel processo di aggiunta di un nodo al decision tree, deve poter inserire il codice univoco del nodo & \hyperref[uc:uc35.1]{UC35.1} \\ \hline
                R-96-F-Op & L'Utente, nel processo di aggiunta di un nodo al decision tree, deve poter inserire il testo della domanda del nodo & \hyperref[uc:uc35.2]{UC35.2} \\ \hline
                R-97-F-Op & L'Utente, per modificare un decision tree, deve poter eliminare un nodo dal decision tree & \hyperref[uc:uc36]{UC36} \\ \hline
                R-98-F-Op & L'Utente deve poter ricevere un errore se cerca di eliminare il nodo root di un decision tree & \hyperref[uc:uc37]{UC37} \\ \hline
                R-99-F-Op & L'Utente, per modificare un decision tree, deve poter modificare la destinazione di un collegamento del decision tree & \hyperref[uc:uc38]{UC38} \\ \hline
                R-100-F-Op & L'Utente deve poter ricevere un errore se la validazione della modifica del decision tree fallisce & \hyperref[uc:uc39]{UC39} \\ \hline
                R-101-F-Op & L'Utente deve poter annullare il processo di modifica di un decision tree & \hyperref[uc:uc40]{UC40} \\ \hline
                R-102-F-Op & L'Utente deve poter esportare un decision tree & \hyperref[uc:uc41]{UC41} \\ \hline
...
\section{Tracciamento dei Requisiti}{
    \rowcolors{2}{lightblue}{white}
                ...
                R-3-F-Ob & \hyperref[uc:uc3]{UC3} \\ \hline
                ...
                R-28-F-Ob & \hyperref[uc:uc13]{UC13} \\ \hline
                ...
                R-34-F-Ob & \hyperref[uc:uc13]{UC13} \\ \hline
                ...
                R-43-F-Op & \hyperref[uc:uc13]{UC13} \\ \hline
                R-44-F-Op & \hyperref[uc:uc18]{UC18} \\ \hline
                R-45-F-Ob & \hyperref[uc:uc19]{UC19} \\ \hline
                R-46-F-Ob & \hyperref[uc:uc20]{UC20}, \hyperref[uc:uc21]{UC21}\\ \hline
                R-47-F-Ob & \hyperref[uc:uc22]{UC22} \\ \hline
                R-48-F-Ob & \hyperref[uc:uc22.1]{UC22.1} \\ \hline
                R-49-F-Ob & \hyperref[uc:uc22.2]{UC22.2} \\ \hline
                R-50-F-Ob & \hyperref[uc:uc22.3]{UC22.3} \\ \hline
                R-51-F-Ob & \hyperref[uc:uc22.4]{UC22.4} \\ \hline
                R-52-F-Ob & \hyperref[uc:uc23]{UC23} \\ \hline
                R-53-F-Ob & \hyperref[uc:uc23.1]{UC23.1} \\ \hline
                R-54-F-Ob & \hyperref[uc:uc23.2]{UC23.2} \\ \hline
                R-55-F-Ob & \hyperref[uc:uc23.3]{UC23.3} \\ \hline
                R-56-F-Ob & \hyperref[uc:uc23.4]{UC23.4} \\ \hline
                R-57-F-Ob & \hyperref[uc:uc23.5]{UC23.5} \\ \hline
                ...
                R-65-F-Op & \hyperref[uc:uc27.1]{UC27.1} \\ \hline
                R-66-F-Op & \hyperref[uc:uc33.2]{UC33.2} \\ \hline
                R-67-F-Op & \hyperref[uc:uc27.1.1]{UC27.1.1} \\ \hline
                R-68-F-Ob & \hyperref[uc:uc28]{UC28} \\ \hline
                R-69-F-Ob & \hyperref[uc:uc28.1]{UC28.1} \\ \hline
                R-70-F-Ob & \hyperref[uc:uc22.1]{UC22.1} \\ \hline
                R-71-F-Ob & \hyperref[uc:uc28.1.1]{UC28.1.1} \\ \hline
                R-72-F-Ob & \hyperref[uc:uc29]{UC29} \\ \hline
                R-73-F-Op & \hyperref[uc:uc30]{UC30} \\ \hline
                R-74-F-Op & \hyperref[uc:uc30.1]{UC30.1} \\ \hline
                R-75-F-Op & \hyperref[uc:uc30.2]{UC30.2} \\ \hline
                R-76-F-Op & \hyperref[uc:uc30.3]{UC30.3} \\ \hline
                R-77-F-Op & \hyperref[uc:uc30.4]{UC30.4} \\ \hline
                R-78-F-Op & \hyperref[uc:uc30.5]{UC30.5} \\ \hline
                ...
                R-82-F-Op & \hyperref[uc:uc32.1]{UC32.1} \\ \hline
                R-83-F-Op & \hyperref[uc:uc33]{UC33} \\ \hline
                R-84-F-Op & \hyperref[uc:uc33.1]{UC33.1} \\ \hline
                R-85-F-Op & \hyperref[uc:uc33.2]{UC33.2} \\ \hline
                R-86-F-Op & \hyperref[uc:uc33.3]{UC33.3} \\ \hline
                R-87-F-Op & \hyperref[uc:uc33.4]{UC33.4} \\ \hline
                R-88-F-Op & \hyperref[uc:uc33.4.1]{UC33.4.1} \\ \hline
                R-89-F-Op & \hyperref[uc:uc33.4.1.1]{UC33.4.1.1} \\ \hline
                R-90-F-Op & \hyperref[uc:uc33.4.1.2]{UC33.4.1.2}  \\ \hline
                R-91-F-Op & \hyperref[uc:uc33.4.2]{UC33.4.2} \\ \hline
                R-92-F-Op & \hyperref[uc:uc33.4.3]{UC33.4.3} \\ \hline
                R-93-F-Op & \hyperref[uc:uc34]{UC34} \\ \hline
                R-94-F-Op & \hyperref[uc:uc35]{UC35} \\ \hline
                R-95-F-Op & \hyperref[uc:uc35.1]{UC35.1} \\ \hline
                R-96-F-Op & \hyperref[uc:uc35.2]{UC35.2} \\ \hline
                R-97-F-Op & \hyperref[uc:uc36]{UC36} \\ \hline
                R-98-F-Op & \hyperref[uc:uc37]{UC37} \\ \hline
                R-99-F-Op & \hyperref[uc:uc38]{UC38} \\ \hline
                R-100-F-Op & \hyperref[uc:uc39]{UC39} \\ \hline
                R-101-F-Op & \hyperref[uc:uc40]{UC40} \\ \hline
                R-102-F-Op & \hyperref[uc:uc41]{UC41} \\ \hline
    ...
    \subsection{Riepilogo}{
        ...
        \rowcolors{2}{lightblue}{white}
            \begin{tabular}{|l|l|l|l|l|}
                ...
                \hline
                Funzionali & 60 & 1 & 41 & 102 \\
                \hline
                Qualità & 7 & 0 & 0 & 7 \\
                \hline
                Vincolo & 6 & 0 & 0 & 6 \\
                \hline
                \textbf{Totali} & \textbf{73} & \textbf{1} & \textbf{41} & \textbf{115} \\
                \hline
            \end{tabular}
