...
\newcommand{\DataUltimaModifica}{2026/02/26}
\newcommand{\LogoGruppo}{../../../Assets/AtlasLogo.png} 

% --- Nuove variabili aggiunte ---
\newcommand{\VersioneDocumento}{v1.0.1} % <-- modifica qui la versione o ID
...
\section*{Registro delle modifiche}
    ...
    \rowcolors{2}{lightblue}{white} 
        \begin{tabularx}{\textwidth}{|l|l|l|X|X|}
            ...
            \hline
            \VersioneDocumento & \DataUltimaModifica & Riccardo Valerio & Giacomo Giora & Sistemati requisiti non funzionali \\
            \hline
        ...
        \noindent Il Caso d'Uso UC25 include un ulteriore Caso d'Uso come raffigurato nella seguente immagine:
            ...
            \begin{itemize}
                ...
                \begin{itemize}
                    ...
                    \item Il Sistema riprende l'esecuzione del test dall'ultimo \textit{nodo}\textsubscript{\href{https://atlasteam9.github.io/Atlas/glossario.html\#Nodo}{G}} [\hyperref[uc:uc6]{UC6}].
                \end{itemize} 
                 \item \textbf{Inclusioni}: 
                 \begin{itemize}
                    \item \hyperref[uc:uc6]{UC6  Esecuzione del test}
