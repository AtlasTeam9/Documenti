...
\newcommand{\DataUltimaModifica}{2026/01/15}
\newcommand{\LogoGruppo}{../../../Assets/AtlasLogo.png} 

% --- Nuove variabili aggiunte ---
\newcommand{\VersioneDocumento}{v0.12.1} % <-- modifica qui la versione o ID
...
\section*{Registro delle modifiche}
    ...
    \rowcolors{2}{lightblue}{white} 
        \begin{tabularx}{\textwidth}{|l|l|l|X|X|}
            ...
            \hline
            \VersioneDocumento & 2026/01/18 & Michele Tesser & Andrea Difino & Sistemati indici casi d'uso \\
            \hline
            v0.12.0 & 2026/01/17 & Michele Tesser & Andrea Difino & Aggiunti casi d'uso e modificate estensioni \\
            \hline
            v0.11.0 & 2026/01/15 & Michele Tesser & Andrea Difino & Prima stesura requisiti di vincolo \\
            \hline
            v0.10.0 & 2026/01/14 & Michele Tesser & Andrea Difino & Prima stesura requisiti di qualità \\
            \hline
            v0.9.0 & 2026/01/13 & Michele Tesser & Andrea Difino & Completati requisiti funzionali \\
            \hline
            v0.8.4 & 2026/01/12 & Michele Tesser & Andrea Difino & Continuati requisiti e aggiunti UC \\
            \hline
    ...
    \subsection{Elenco Casi d'Uso}{
        ...
        \label{uc:uc3}
         ...
         \subsubsection{UC4 - Espandi informazioni dispositivo} 
            \label{uc:uc4} Guardare se unificare con UC4.1
                        \begin{itemize}
                            \item \textbf{Attore}: Utente
        ...
        \subsubsection{UC5 - Modifica asset dispositivo}
        \label{uc:uc5} 
        Inserire commento (se è presente una lista di asset salvata manualmente) UC16. Deve essere messo al singolare. Vedere se creare singoli casi d'uso per lo scenario principale
         \begin{center}
                \begin{figure}[H]
                    \centering
        ...
        \begin{itemize}
                ...
                \item \textbf{Post-condizioni}: L’asset del dispositivo è aggiornato e salvato nel sistema
                \item \textbf{Scenario principale}:
                \begin{itemize}
        ...
        \begin{itemize}
                \item \textbf{Attore}: Utente
                \item \textbf{Pre-condizioni}: Il Sistema presenta un dispositivo con i relativi assets caricati. L’Utente seleziona un pulsante per l‘avvio del test.
                ...
                \item \textbf{Scenari alternativi}:
                \begin{itemize}
                    \item L’Utente seleziona l’uscita dal test [\hyperref[uc:uc9]{UC9}]
                \end{itemize}
        ...
        Il Caso d’Uso UC6 include due ulteriori Casi d’Uso come raffigurato nella seguente immagine:
                ...
                \begin{itemize}
                    ...
                    \begin{itemize}
                        ...
                        \item Il Sistema mostra i pulsanti di risposta SÌ e NO
                        \item La domanda é identificata da: 
                        \begin{itemize}
                            \item Nome univoco collegato al nodo del decision Tree
                ...
                \noindent Il Caso d’Uso UC6.2 include un ulteriore Caso d’Uso come raffigurato nella seguente immagine:

                \begin{center}
                    \begin{figure}[H]
                        \centering
                        %\includegraphics[scale=0.58]{img/UC6.2Inclusioni.png}
                        \caption{UC6.2 -  Inclusioni Caso d'Uso 6.2: UC6.2.1}
        ...
        \subsubsection{UC - Esportazione test completato} 
            \label{uc:uc}
            \begin{itemize}
                \item \textbf{Attore}: Utente
        ...
        \begin{itemize}
            ...
            \item \textbf{Post-condizioni}: Il Sistema mostra la domanda successiva nella storia in avanti aggiornata. Se si raggiunge l’ultima domanda, la freccia avanti torna disabilitata.
            \item \textbf{Scenario principale}:
            \begin{itemize}
            ...
            \item \textbf{Scenari alternativi}:
            \begin{itemize}
                \item La modifica della risposta porta alla conclusione del test \hyperref[uc:uc6.2]{[UC6.2]}
            \end{itemize} 
            \item \textbf{Estensioni}: \hyperref[uc:uc6.2]{UC6.2 Visualizzazione risultati test}
        \end{itemize}   
        ...
        \begin{itemize}
            ...
            \item \textbf{Post-condizioni}: Il form per l'inserimento dei dati del dispositivo è caricato
            \item \textbf{Scenario principale}:
            \begin{itemize}
        ...
        \noindent Il Caso d’Uso UC10 include un ulteriore Caso d’Uso come raffigurato nella seguente immagine:
                ...
                \begin{itemize}
                    \item \textbf{Attore}: Utente
                    \item \textbf{Post-condizioni}: Il Sistema mostra il form di inserimento
                    \item \textbf{Scenario principale}:
                    \begin{itemize}
                    ...
                    \item \textbf{Inclusioni}:
                    \begin{itemize}
                        \item \hyperref[uc:uc10.1.1]{UC10.1.1 Inserimento campo dispositivo}
                    \end{itemize}
                \end{itemize} 
        ...
        \noindent Il Caso d’Uso UC10.1 include un ulteriore Caso d’Uso come raffigurato nella seguente immagine:
                ...
                \paragraph{UC10.1.1 - Inserimento campo dispositivo} \mbox{}
                \label{uc:uc10.1.1}
                \begin{itemize}
                    \item \textbf{Attore}: Utente
                    \item \textbf{Post-condizioni}: Un campo del dispositivo è stato inserito/modificato
                    \item \textbf{Scenario principale}:
                    \begin{itemize}
                        \item L'Utente seleziona un campo del form
                        \item L'Utente inserisce o modifica il valore
                        \item Il Sistema memorizza il valore inserito
                    \end{itemize}
                    \item \textbf{Generalizzazioni}:
                    \begin{itemize}
                        \item[-] \hyperref[uc:uc10.1.1.1]{UC10.1.1.1 Inserimento nome }
                        \item[-] \hyperref[uc:uc10.1.1.2]{UC10.1.1.2 Inserimento sistema operativo}
                        \item[-] \hyperref[uc:uc10.1.1.3]{UC10.1.1.3 Inserimento versione firmware}
                        \item[-] \hyperref[uc:uc10.1.1.4]{UC10.1.1.4 Inserimento funzionalità}
                        \item[-] \hyperref[uc:uc10.1.1.5]{UC10.11..5 Inserimento descrizione}
                    \end{itemize}
                \end{itemize} 

                \noindent Il Caso d’Uso UC10.1.1 é generalizzato in cinque ulteriori Caso d’Uso come raffigurato nella seguente immagine:
                
                        \begin{center}
                            \begin{figure}[H]
                                \centering
                                %\includegraphics[scale=0.58]{img/UC10.1.1Generalizzazioni.png}
                                \caption{UC10.1.1 -  Generalizzazioni Caso d'Uso 10.1.1: UC10.1.1.1, UC10.1.1.2, UC10.1.1.3, UC10.1.1.4, UC10.1.1.5}
                                \label{fig:uc10.1.1-generalizzazioni}
                            \end{figure}
                        \end{center}

                \paragraph{UC10.1.1.1 - Inserimento nome} \mbox{}
                \label{uc:uc10.1.1.1}
                \begin{itemize}
                    \item \textbf{Attore}: Utente
                ...
                \paragraph{UC10.1.1.2 - Inserimento sistema operativo} \mbox{}
                \label{uc:uc10.1.1.2}
                \begin{itemize}
                    \item \textbf{Attore}: Utente
                ...
                \paragraph{UC10.1.1.3 - Inserimento versione firmware} \mbox{}
                \label{uc:uc10.1.1.3}
                \begin{itemize}
                    \item \textbf{Attore}: Utente
                ...
                \paragraph{UC10.1.1.4 - Inserimento funzionalità} \mbox{}
                \label{uc:uc10.1.1.4}
                \begin{itemize}
                    \item \textbf{Attore}: Utente
                ...
                \paragraph{UC10.1.1.5 - Inserimento descrizione} \mbox{}
                \label{uc:uc10.1.1.5}
                \begin{itemize}
                    \item \textbf{Attore}: Utente
        ...
        \subsubsection{UC12 - Visualizzazione form per creazione asset}
        \label{uc:uc12}
        
        \begin{itemize}
            \item \textbf{Attore}: Utente
            \item \textbf{Pre-condizioni}: L'Utente si trova nella sezione di gestione asset del dispositivo
            \item \textbf{Post-condizioni}: L'Utente visualizza il form per la creazione di un nuovo asset
            \item \textbf{Scenario principale}:
            \begin{itemize}
                \item L'Utente seleziona la funzionalità di aggiunta asset
                \item Il Sistema mostra il form vuoto per la creazione dell'asset
                \item Il Sistema abilita i campi per l'inserimento dati
            \end{itemize}
            \item \textbf{Scenari alternativi}:
            \begin{itemize}
                \item L'Utente decide di annullare l'operazione [\hyperref[uc:uc13]{UC13}]
            \end{itemize}
            \item \textbf{Estensioni}: \hyperref[uc:uc13]{UC13 Annullamento creazione asset}
        \end{itemize}
        
        \paragraph{UC13 - Annullamento creazione asset} \mbox{}
        \label{uc:uc13}
        
        \begin{itemize}
            \item \textbf{Attore}: Utente
            \item \textbf{Pre-condizioni}: L'Utente sta visualizzando il form per la creazione asset
            \item \textbf{Post-condizioni}: L'Utente ritorna alla lista degli asset senza aver creato l'asset
            \item \textbf{Scenario principale}:
            \begin{itemize}
                \item L'Utente seleziona la funzionalità di annullamento
                \item Il Sistema chiude il form di creazione
                \item Il Sistema mostra nuovamente la lista degli asset
            \end{itemize}
        \end{itemize}
        
        \subsubsection{UC14 - Inserimento dati asset}
        \label{uc:uc14}
        
        \begin{itemize}
            \item \textbf{Attore}: Utente
            \item \textbf{Pre-condizioni}: Il form per la creazione asset è visualizzato
            \item \textbf{Post-condizioni}: I dati dell'asset sono stati inseriti nel form
            \item \textbf{Scenario principale}:
            \begin{itemize}
                \item L'Utente compila i seguenti campi:
                \begin{itemize}
                ...
                \end{itemize}
                \item Il Sistema memorizza temporaneamente i valori inseriti
            \end{itemize}
            \item \textbf{Scenari alternativi}:
            \begin{itemize}
                \item L'Utente inserisce dati non validi [\hyperref[uc:uc15]{UC15}]
            \end{itemize}
            \item \textbf{Inclusioni}:
            \begin{itemize}
                ...
                \end{itemize}
            \item \textbf{Estensioni}: \hyperref[uc:uc15]{UC15 Validazione dati asset non riuscita}
        \end{itemize}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item L'Utente inserisce il nome dell'asset
        ...
        \begin{itemize}
            \item \textbf{Attore}: Utente
            \item \textbf{Post-condizioni}: Il tipo dell'asset è stato selezionato
            \item \textbf{Scenario principale}:
            \begin{itemize}
                \item L'Utente seleziona il campo "Tipo asset"
                \item L'Utente sceglie il tipo dall'elenco disponibile
        ...
        \begin{itemize}
            \item \textbf{Attore}: Utente
            \item \textbf{Post-condizioni}: La sensibilità dell'asset è stata selezionata
            \item \textbf{Scenario principale}:
            \begin{itemize}
                \item L'Utente seleziona il campo "Sensibilità"
                \item L'Utente sceglie il livello di sensibilità dall'elenco
                \item Il Sistema memorizza la selezione
            \end{itemize}
        \end{itemize}
        
        \paragraph{UC15 - Validazione dati asset non riuscita} \mbox{}
        \label{uc:uc15}
        
        \begin{itemize}
            \item \textbf{Attore}: Utente
            \item \textbf{Pre-condizioni}: L'Utente ha inserito dati non validi per l'asset
            \item \textbf{Post-condizioni}: Il Sistema segnala gli errori all'Utente
            \item \textbf{Scenario principale}:
            \begin{itemize}
                \item Il Sistema rileva errori nei dati inseriti
                \item Il Sistema mostra messaggi di errore per i campi problematici
                \item Il Sistema impedisce il proseguimento fino alla correzione
                \item L'Utente corregge i dati errati
            \end{itemize}
        \end{itemize}
        
        \subsubsection{UC16 - Salvataggio asset creato}
        \label{uc:uc16}
        
        \begin{itemize}
            \item \textbf{Attore}: Utente
            \item \textbf{Pre-condizioni}: L'Utente ha compilato tutti i campi obbligatori dell'asset
            \item \textbf{Post-condizioni}: L'asset è stato salvato nel sistema
            \item \textbf{Scenario principale}:
            \begin{itemize}
                \item L'Utente seleziona la funzionalità di salvataggio dell'asset
                \item Il Sistema valida i dati inseriti
                \item Il Sistema aggiunge l'asset alla lista degli asset del dispositivo
                \item Il Sistema aggiorna la visualizzazione della lista asset
                \item Il Sistema conferma il salvataggio
            \end{itemize}
        \end{itemize}
        
        \subsubsection{UC17 - Visualizzazione lista asset}
        \label{uc:uc17}
        
        \begin{itemize}
            \item \textbf{Attore}: Utente
            \item \textbf{Pre-condizioni}: Il dispositivo ha almeno un asset associato
            \item \textbf{Post-condizioni}: L'Utente visualizza la lista degli asset
            \item \textbf{Scenario principale}:
            \begin{itemize}
                \item Il Sistema recupera gli asset associati al dispositivo
                \item Il Sistema ordina gli asset secondo criteri definiti
                \item Il Sistema mostra la lista degli asset con:
                \begin{itemize}
                    \item Nome dell'asset
                    \item Tipo dell'asset
                \end{itemize}
            \end{itemize}
            \item \textbf{Inclusioni}: \hyperref[uc:uc18]{UC18 Visualizzazione dettagli asset}
        \end{itemize}
        
        \paragraph{UC18 - Visualizzazione dettagli asset} \mbox{}
        \label{uc:uc18}
        
        \begin{itemize}
            \item \textbf{Attore}: Utente
            \item \textbf{Pre-condizioni}: L'Utente seleziona un asset dalla lista
            \item \textbf{Post-condizioni}: Vengono visualizzati i dettagli dell'asset selezionato
            \item \textbf{Scenario principale}:
            \begin{itemize}
                \item L'Utente seleziona un asset dalla lista
                \item Il Sistema mostra i dettagli completi dell'asset:
                \begin{itemize}
                    \item Nome
                    \item Tipo
                    \item Descrizione
        ...
        \subsubsection{UC19 - Eliminazione asset}
        \label{uc:uc19}
        
        \begin{itemize}
            \item \textbf{Attore}: Utente
            \item \textbf{Pre-condizioni}: È presente almeno un asset nella lista
            \item \textbf{Post-condizioni}: L'asset selezionato è stato eliminato
            \item \textbf{Scenario principale}:
            \begin{itemize}
                \item L'Utente seleziona un asset dalla lista
                \item L'Utente seleziona la funzionalità di eliminazione
                \item Il Sistema chiede conferma dell'eliminazione
                \item L'Utente conferma l'eliminazione
                \item Il Sistema rimuove l'asset dal dispositivo
                \item Il Sistema aggiorna la lista degli asset
                \item Il Sistema conferma l'eliminazione
            \end{itemize}
        \end{itemize}
        
        \subsubsection{UC20 - Modifica asset esistente}
        \label{uc:uc20}
        
        \begin{itemize}
            \item \textbf{Attore}: Utente
            \item \textbf{Pre-condizioni}: L'Utente ha selezionato un asset dalla lista
            \item \textbf{Post-condizioni}: L'asset è stato modificato e salvato
            \item \textbf{Scenario principale}:
            \begin{itemize}
                \item L'Utente seleziona la funzionalità di modifica di un asset
                \item Il Sistema mostra il form con i dati correnti dell'asset
                \item L'Utente modifica i campi desiderati [\hyperref[uc:uc14]{UC14}]
                \item L'Utente conferma le modifiche
                \item Il Sistema valida e aggiorna l'asset
                \item Il Sistema aggiorna la lista degli asset
            \end{itemize}
            \item \textbf{Scenari alternativi}:
            \begin{itemize}
                \item L'Utente annulla la modifica [\hyperref[uc:uc21]{UC21}]
            \end{itemize}
        \end{itemize}
        
        \paragraph{UC21 - Annullamento modifica asset} \mbox{}
        \label{uc:uc21}
        
        \begin{itemize}
            \item \textbf{Attore}: Utente
            \item \textbf{Pre-condizioni}: L'Utente sta modificando un asset
            \item \textbf{Post-condizioni}: Le modifiche vengono scartate
            \item \textbf{Scenario principale}:
            \begin{itemize}
                \item L'Utente seleziona la funzionalità di annullamento durante la modifica
                \item Il Sistema chiede conferma dell'annullamento
                \item L'Utente conferma
                \item Il Sistema scarta le modifiche non salvate
                \item Il Sistema ritorna alla visualizzazione della lista asset
            \end{itemize}
        \end{itemize}

        \subsubsection{UC22 - Annullamento inserimento dati dispositivo}
            \label{uc:uc22}
            \begin{itemize}
                \item \textbf{Attore}: Utente
                ...
                \item \textbf{Scenario principale}:
                \begin{itemize}
                    \item L’Utente si trova nel processo di creazione del dispositivo
                    \item L’Utente seleziona la funzionalità di annullamento.
            ...
            \subsubsection{UC23 - Controllo dati del dispositivo}
            \label{uc:uc23}
            \begin{itemize}
                \item \textbf{Attore}: Utente
                \item \textbf{Pre-condizioni}: I dati identificativi del dispositivo sono stati creati e salvati
                \item \textbf{Post-condizioni}: 
                \begin{itemize}
                    \item I dati del dispositivo risultano aggiornati
                    \item L’Utente viene riportato alla sezione di gestione degli assets
                \end{itemize}
                \item \textbf{Scenario principale}:
                \begin{itemize}
                    \item L’Utente si trova nella sezione di inserimento o visualizzazione degli asset
                    \item L’Utente seleziona la funzionalità di controllo dei dati del dispositivo
                    \item Il Sistema carica il form dei dati del dispositivo precedetemente compilato
                    \item L’Utente controlla/modifica uno o più campi del dispositivo
                    \item Il Sistema riporta l’Utente alla sezione di gestione degli asset
                \end{itemize}
                \item \textbf{Inclusioni}: 
                \begin{itemize}
                    \item[-] \hyperref[uc:uc10.1]{UC10.1 Visualizzazione form dati dispositivo}
                    \item[-] \hyperref[uc:uc11]{UC11 Salvataggio dati del dispositivo inseriti manualmente}
                \end{itemize}
            \end{itemize}

            \subsubsection{UC24 - Salvataggio della lista di assets}
            \label{uc:uc24}
            \begin{itemize}
                \item \textbf{Attore}: Utente
                ...
                \item \textbf{Post-condizioni}: Il dispositivo con la sua lista di assets è salvato
                \item \textbf{Scenario principale}:
                \begin{itemize}
                    \item L’Utente ha completato la creazione della lista di asset.
                    \item L’Utente seleziona la funzionalità di salvataggio.
                    \item Il Sistema rende il dispositivo modificabile.
                \end{itemize} 
            \end{itemize}

            \subsubsection{UC25 - Caricamento test precedente}
            \label{uc:uc25}
            \begin{itemize}
                \item \textbf{Attore}: Utente
                ...
                \end{itemize} 
                \item \textbf{Inclusioni}: \hyperref[uc:uc6.2]{UC6.2 Visualizzazione risultati test}
                \item \textbf{Estensioni}: \hyperref[uc:uc2]{UC2 Rilevamento file non valido}
            \end{itemize}
             ...
             \noindent Il Caso d’Uso UC25 include un ulteriore Caso d’Uso come raffigurato nella seguente immagine:
                    ...
                    \begin{center}
                        \begin{figure}[H]
                            \centering
                            %\includegraphics[scale=0.58]{img/UC25Inclusioni.png}
                            \caption{UC25 -  Inclusioni Caso d'Uso 25: UC6.2}
                            \label{fig:uc25-inclusioni}
                        \end{figure}
                    \end{center}

            \subsubsection{UC26 - Modifica del risultato del test}
            \label{uc:uc26}
            \begin{itemize}
                \item \textbf{Attore}: Utente
                \item \textbf{Pre-condizioni}: É presente nel sistema un test completato
                \item \textbf{Post-condizioni}: Il test è aggiornato e i nuovi risultati sono salvati.
                \item \textbf{Scenario principale}:
                \begin{itemize}
                    \item L’Utente seleziona un requisito da modificare.
                    \item Il Sistema avvia l’esecuzione del test a partire da quel requisito.
                \end{itemize} 
            ...
            \noindent Il Caso d’Uso UC26 include un ulteriore Caso d’Uso come raffigurato nella seguente immagine:
                    ...
                    \begin{center}
                        \begin{figure}[H]
                            \centering
                            %\includegraphics[scale=0.58]{img/UC26Inclusioni.png}
                            \caption{UC26 -  Inclusioni Caso d'Uso 26: UC6}
                            \label{fig:uc26-inclusioni}
                        \end{figure}
                    \end{center}

            \subsubsection{UC27 - Completamento di un test non finito}
            \label{uc:uc27}
            \begin{itemize}
                \item \textbf{Attore}: Utente
                \item \textbf{Pre-condizioni}: È stato caricato un test non completato
                \item \textbf{Post-condizioni}: Il test riprende dall'ultimo nodo
                \item \textbf{Scenario principale}:
                \begin{itemize}
                    \item L’Utente carica un test non completato.
                    \item L'Utente riprende l'esecuzione del test dall'ultimo nodo [\hyperref[uc:uc6]{UC6}].
                \end{itemize} 
                 \item \textbf{Inclusioni}: \hyperref[uc:uc6]{UC6  Esecuzione del test}
            \end{itemize}
            ...
            \noindent Il Caso d’Uso UC27 include un ulteriore Caso d’Uso come raffigurato nella seguente immagine:
                    ...
                    \begin{center}
                        \begin{figure}[H]
                            \centering
                            %\includegraphics[scale=0.58]{img/UC27Inclusioni.png}
                            \caption{UC27 -  Inclusioni Caso d'Uso 27: UC6}
                            \label{fig:uc27-inclusioni}
                        \end{figure}
                    \end{center}

            \subsubsection{UC28 - Giustificazioni test}
            \label{uc:uc28}
            \begin{itemize}
                \item \textbf{Attore}: Utente
                \item \textbf{Pre-condizioni}: E’ presente un test completato
            ...
            \subsubsection{UC29 - Accesso all’editor grafico dei decision tree}
            \label{uc:uc29}
            Sostituire visualizzazione elenco con questo caso d'uso .
            Togliere estensione 
            \begin{itemize}
                \item \textbf{Attore}: Utente
                ...
                \end{itemize}
                \item \textbf{Inclusioni}: \hyperref[uc:uc29.1]{UC29.1 Visualizzazione elenco decision tree} 
            \end{itemize}

            \noindent Il Caso d’Uso UC29 include un ulteriore Caso d’Uso come raffigurato nella seguente immagine:
                
                    \begin{center}
                        \begin{figure}[H]
                            \centering
                            %\includegraphics[scale=0.58]{img/UC29Inclusioni.png}
                            \caption{UC29 -  Inclusioni Caso d'Uso 29: UC29.1}
                            \label{fig:uc29-inclusioni}
                        \end{figure}
                    \end{center}

                    \paragraph{UC29.1 - Visualizzazione elenco decision trees} \mbox{}
                    \label{uc:uc29.1}
                    \begin{itemize}
                        \item \textbf{Attore}: Utente
                        ...
                        \end{itemize}
                        \item \textbf{Inclusioni}: \hyperref[uc:uc29.1.1]{UC29.1.1 Visualizzazione singolo decision tree} 
                    \end{itemize}

                    \noindent Il Caso d’Uso UC29.1 include un ulteriore Caso d’Uso come raffigurato nella seguente immagine:
                
                    \begin{center}
                        \begin{figure}[H]
                            \centering
                            %\includegraphics[scale=0.58]{img/UC29.1Inclusioni.png}
                            \caption{UC29.1 -  Inclusioni Caso d'Uso 29.1: UC29.1.1}
                            \label{fig:uc29.1-inclusioni}
                        \end{figure}
                    \end{center}

                    \paragraph{UC29.1.1 - Visualizzazione singolo decision tree} \mbox{}
                    \label{uc:uc29.1.1}
                    \begin{itemize}
                        \item \textbf{Attore}: Utente
                        ...
                        \begin{itemize}
                            ...
                            \begin{itemize}
                                \item id del requisito [\hyperref[uc:uc29.1.1.1]{UC29.1.1.1}]
                                \item titolo [\hyperref[uc:uc29.1.1.2]{UC29.1.1.2}]
                                \item dipendenze (se presenti) [\hyperref[uc:uc29.1.1.3]{UC29.1.1.3}]
                            \end{itemize}
                        \end{itemize}
                        \item \textbf{Inclusioni}: 
                        \begin{itemize}
                            \item \hyperref[uc:uc29.1.1.1]{UC29.1.1.1 Visualizzazione id del requisito del decision tree}
                            \item \hyperref[uc:uc29.1.1.2]{UC29.1.1.2 Visualizzazione titolo del decision tree}
                            \item \hyperref[uc:uc29.1.1.3]{UC29.1.1.3 Visualizzazione dipendenze del decision tree}
                        \end{itemize} 
                    \end{itemize}

                    \noindent Il Caso d’Uso UC29.1.1 include tre ulteriori Casi d’Uso come raffigurato nella seguente immagine:
                
                    \begin{center}
                        \begin{figure}[H]
                            \centering
                            %\includegraphics[scale=0.58]{img/UC29.1.1Inclusioni.png}
                            \caption{UC29.1.1 -  Inclusioni Caso d'Uso 29.1.1: UC29.1.1.1, UC29.1.1.2, UC29.1.1.3, UC29.1.1.4}
                            \label{fig:uc29.1.1-inclusioni}
                        \end{figure}
                    \end{center}

                    \paragraph{UC29.1.1.1 - Visualizzazione id del requisito del decision tree} \mbox{}
                    \label{uc:uc29.1.1.1}
                    \begin{itemize}
                        \item \textbf{Attore}: Utente
                    ...
                    \end{itemize}
                     ...
                     \paragraph{UC29.1.1.2 - Visualizzazione titolo del decision tree} \mbox{}
                    \label{uc:uc29.1.1.2}
                    \begin{itemize}
                        \item \textbf{Attore}: Utente
                    ...
                    \end{itemize}
                     ...
                     \paragraph{UC29.1.1.3 - Visualizzazione dipendenze del decision tree} \mbox{}
                    \label{uc:uc29.1.1.3}
                    \begin{itemize}
                        \item \textbf{Attore}: Utente
            ...
            \subsubsection{UC30 - Selezione decision tree da modificare}
            \label{uc:uc30}
            Sostituire UC22.1 con questo caso d'uso padre
            \begin{itemize}
                \item \textbf{Attore}: Utente
                ...
                \end{itemize}
                \item \textbf{Inclusioni}: \hyperref[uc:uc30.1]{UC30.1 Visualizzazione grafica del decision tree} 
            \end{itemize}
            ...
            \noindent Il Caso d’Uso UC30 include un ulteriore Caso d’Uso come raffigurato nella seguente immagine:
                    ...
                    \paragraph{UC30.1 - Visualizzazione grafica del decision tree} \mbox{}
                    \label{uc:uc30.1}
                    \begin{itemize}
                        \item \textbf{Attore}: Utente
            ...
            \subsubsection{UC31 - Modifica del decision tree}
            \label{uc:uc31}
            \begin{itemize}
                \item \textbf{Attore}: Utente
                ...
                \begin{itemize}
                    ...
                    \item Il Sistema aggiorna il decision tree.
                \end{itemize}
                \item \textbf{Scenari alternativi}:
                \begin{itemize}
                    \item L’Utente annulla l'operazione di modifica [\hyperref[uc:uc38]{UC38}].
                \end{itemize}
                \item \textbf{Estensioni}:
                \begin{itemize}
                    \item \hyperref[uc:uc38]{UC38 Annullamento dell'operazione di modifica}.
                \end{itemize}
                \item \textbf{Generalizzazioni}:
                \begin{itemize}
                    \item \hyperref[uc:uc32]{UC32 Aggiunta nodo al decision tree}
                    \item \hyperref[uc:uc33]{UC33 Eliminazione nodo del decision tree}
                    \item \hyperref[uc:uc35]{UC35 Modifica collegamenti tra nodi}
                \end{itemize}
            \end{itemize}

            \subsubsection{UC32 - Aggiunta nodo al decision tree}
            \label{uc:uc32}
            \begin{itemize}
                \item \textbf{Attore}: Utente
                \item \textbf{Pre-condizioni}: Un decision tree è visualizzato nell’editor.
                ...
                \begin{itemize}
                    ...
                    \item Il Sistema aggiorna la visualizzazione.
                \end{itemize}
            \end{itemize}

            \subsubsection{UC33 - Eliminazione nodo del decision tree}
            \label{uc:uc33}
            \begin{itemize}
                \item \textbf{Attore}: Utente
                ...
                \item \textbf{Scenari alternativi}:
                \begin{itemize}
                    \item L'Utente cerca di eliminare il nodo root [\hyperref[uc:uc34]{UC34}]
                \end{itemize}
                \item \textbf{Estensioni}:
                \begin{itemize}
                    \item \hyperref[uc:uc34]{UC34 Tentativo eliminazione nodo root}
                \end{itemize}
            \end{itemize}

            \subsubsection{UC34 - Tentativo eliminazione nodo root}
            \label{uc:uc34}
            \begin{itemize}
                \item \textbf{Attore}: Utente
                \item \textbf{Pre-condizioni}: L'Utente cerca di eliminare il nodo root.
                \item \textbf{Post-condizioni}: L'eliminazione non viene eseguita.
                \item \textbf{Scenario principale}:
                \begin{itemize}
                    \item Il Sistema rileva che il nodo selezionato è il root.
                    \item Il Sistema mostra un messaggio di errore.
                    \item Il Sistema spiega che il nodo root non può essere eliminato.
                \end{itemize}
            \end{itemize}

            \subsubsection{UC35 - Modifica collegamenti tra nodi}
            \label{uc:uc35}
            \begin{itemize}
                \item \textbf{Attore}: Utente
            ...
            \subsubsection{UC36 - Validazione del decision tree}
            \label{uc:uc36}
            \begin{itemize}
                \item \textbf{Attore}: Utente
                ...
                \item \textbf{Scenari alternativi}:
                \begin{itemize}
                    \item Il decision tree modificato presenta uno o piú errori  [\hyperref[uc:uc37]{UC37}].
                \end{itemize}
                \item \textbf{Estensioni}: 
                \begin{itemize}
                    \item \hyperref[uc:uc37]{UC37 Segnalazione errori del decision tree}
                \end{itemize} 
            \end{itemize}

            \subsubsection{UC37 - Segnalazione errori del decision tree}
            \label{uc:uc37}
            \begin{itemize}
                \item \textbf{Attore}: Utente
            ...
            \subsubsection{UC40 - Caricamento dei dati del dispositivo per la modifica}
            \label{uc:uc40}
            \begin{itemize}
                \item \textbf{Attore}: Utente
                \item \textbf{Pre-condizioni}: Un dispositivo con asset associati è visualizzato nel sistema.
                \item \textbf{Post-condizioni}: L’Utente si trova nell’editor del dispositivo.
                \item \textbf{Scenario principale}:
                \begin{itemize}
                    ...
                    \item Il Sistema porta l’Utente nell’editor del dispositivo.
                \end{itemize}
                \item \textbf{Inclusioni}: \hyperref[uc:uc40.1]{UC40.1 Visualizzazione dati dispositivo in modalitá modifica}
            \end{itemize}

            \noindent Il Caso d’Uso UC40 include un ulteriore Caso d’Uso come raffigurato nella seguente immagine:
                
                    \begin{center}
                        \begin{figure}[H]
                            \centering
                            %\includegraphics[scale=0.58]{img/UC40Inclusioni.png}
                            \caption{UC40 -  Inclusioni Caso d'Uso 40: UC40.1}
                            \label{fig:uc40-inclusioni}
                        \end{figure}
                    \end{center}

                    \paragraph{UC40.1 - Modifica dei dati del dispositivo} \mbox{}
                    \label{uc:uc40.1}
                    \begin{itemize}
                        \item \textbf{Attore}: Utente
                        \item \textbf{Post-condizioni}: I dati identificativi del dispositivo sono stati modificati e salvati
                        \item \textbf{Scenario principale}:
                        \begin{itemize}
                            \item Il Sistema mostra i campi del dispositivo.
                            \item I campi del dispositivo vengono caricati. 
                            \item I campi sono modificabili dall’Utente. [\hyperref[uc:uc10.1.1]{UC10.1.1}]
                        \end{itemize}
                        \item \textbf{Scenario alternativo}:
                        \begin{itemize}
                            \item L'Utente esce dalla modifica senza salvare [\hyperref[uc:uc47]{UC47}]
                        \end{itemize}
                        \item \textbf{Inclusioni}: \hyperref[uc:uc10.1.1]{UC10.1.1 Inserimento campo dispositivo}
                        \item \textbf{Estensioni}: 
                        \hyperref[uc:uc47]{UC47 Uscita dalla modalità di modifica senza salvataggio}
                    \end{itemize}

            \subsubsection{UC41 - Visualizzazione lista asset in modalità modifica}
            \label{uc:uc41}
            \begin{itemize}
                \item \textbf{Attore}: Utente
            ...
            \subsubsection{UC42 - Selezione asset da modificare}
            \label{uc:uc42}
            \begin{itemize}
                \item \textbf{Attore}: Utente
                ...
                \item \textbf{Scenari alternativi}:
                \begin{itemize}
                    \item L'Utente seleziona la funzionalità per modificare l'asset selezionato [\hyperref[uc:uc43]{UC43}]
                \end{itemize}
                \item \textbf{Estensioni}: \hyperref[uc:uc43]{UC43 Modifica dati asset}
            \end{itemize}

            \subsubsection{UC43 - Modifica dati asset}
            \label{uc:uc43}
            Vedere se includere la selezione al posto di fare un caso d'uso a parte. 
            Togliere UC45 da estensioni
            Mettere UC47 come estensione
            \begin{itemize}
                \item \textbf{Attore}: Utente
                ...
                \item \textbf{Scenari alternativi}:
                \begin{itemize}
                    \item L'Utente seleziona la funzionalità per annullare la modifica dell'asset [\hyperref[uc:uc44]{UC44}]
                    \item L'Utente seleziona la funzionalità per salvare la modifica dell'asset [\hyperref[uc:uc45]{UC45}]
                \end{itemize}
                \item \textbf{Estensioni}: 
                \begin{itemize}
                    \item \hyperref[uc:uc44]{UC44 Annullamento modifica asset}
                    \item \hyperref[uc:uc45]{UC45 Conferma modifica asset}
                \end{itemize}
            \end{itemize}

            \subsubsection{UC44 - Annullamento modifica asset}
            \label{uc:uc44}
            \begin{itemize}
                \item \textbf{Attore}: Utente
            ...
            \subsubsection{UC45 - Conferma modifica asset}
            \label{uc:uc45}
            \begin{itemize}
                \item \textbf{Attore}: Utente
                \item \textbf{Pre-condizioni}: Un asset è in fase di modifica.
            ...
            \subsubsection{UC46 - Salvataggio documento dispositivo modificato}
            \label{uc:uc46}
            \begin{itemize}
                \item \textbf{Attore}: Utente
                ...
                \begin{itemize}
                    ...
                    \item Il Sistema conferma il salvataggio.
                \end{itemize}
              \item \textbf{Inclusioni}: \hyperref[uc:uc24]{UC24 Salvataggio della lista di assets}
            \end{itemize}

            \subsubsection{UC47 - Uscita dalla modalità di modifica senza salvataggio}
            \label{uc:uc47}
            \begin{itemize}
                \item \textbf{Attore}: Utente
                ...
                \item \textbf{Scenario principale}:
                \begin{itemize}
                    \item L’Utente seleziona la funzionalità per l'annullamento delle modifiche.
                    \item Il Sistema rileva modifiche non salvate.
                    \item Il Sistema annulla le modifiche apportate al documento.
                    \item l'Utente si trova allo stato iniziale dell'applicazione
                \end{itemize}
            \end{itemize}
    ...
    \subsection{Requisiti funzionali}{
        \rowcolors{2}{lightblue}{white}
            \begin{longtable}{|l|p{0.6\textwidth}|l|}
                ...
                \hline
                R-7-F-Ob & L'Utente deve poter visualizzare il nome di ogni asset del dispositivo & \hyperref[uc:uc4.1]{UC4.1}\\
                \hline
                R-8-F-Ob & L'Utente deve poter visualizzare il tipo di ogni asset del dispositivo & \hyperref[uc:uc4.1]{UC4.1}\\
                \hline
                ...
                \hline
                R-12-F-Ob & L'Utente deve poter salvare le modifiche apportate alla lista degli assets creata manualmente & \hyperref[uc:uc5]{UC5}\\
                \hline
                ...
                \hline
                R-22-F-D & L'Utente deve poter esportare il test completato nei formati previsti dall'applicazione & \hyperref[uc:uc6.2.2]{UC6.2.2}\\
                \hline
                ...
                \hline
                R-27-F-Ob & L'Utente deve avere un salvataggio del test parziale nel caso in cui esca da un test durante la sua esecuzione & \hyperref[uc:uc9.1]{UC9.1}\\
                \hline
                ...
                \hline
                R-34-F-Ob & L'Utente deve poter inserire la descrizone del dispositivo nell'apposito form di creazione & \hyperref[uc:uc10.1.5]{UC10.1.5}\\
                \hline
                ...
                \hline
                R-40-F-Ob & L'Utente deve poter inserire la descrizione dell'asset nel form apposito & \hyperref[uc:uc12.1.3]{UC12.1.3}\\
                \hline
                ...
                \hline
                R-60-F-Op & L'Utente deve poter selezionare un decision tree che intende modificare & \hyperref[uc:uc22]{UC22}\\
                \hline
                R-61-F-Op & L'Utente deve poter visualizzare graficamente il decision tree che intende modificare & \hyperref[uc:uc22.1]{UC22.1}\\
                \hline
                R-62-F-Op & L'Utente deve poter selezionare un nodo del decision tree da modificare & \hyperref[uc:uc23]{UC23}\\
                \hline
                R-63-F-Op & L'Utente deve poter visualizzare il testo della domanda che intende modificare & \hyperref[uc:uc23]{UC23}\\
                \hline
                R-64-F-Op & L'Utente deve poter visualizzare i collegamenti che intende modificare del decision tree & \hyperref[uc:uc23]{UC23}\\
                \hline
                R-65-F-Op & L'Utente deve poter aggiungere un nodo al decision tree & \hyperref[uc:uc24]{UC24}\\
                \hline
                R-66-F-Op & L'Utente deve poter eliminare un nodo del decision tree & \hyperref[uc:uc25]{UC25}\\
                \hline
                R-67-F-Op & L'Utente deve poter modificare i collegamenti tra i nodi di un decision tree & \hyperref[uc:uc26]{UC26}\\
                \hline
                R-68-F-Op & L'Utente deve poter sapere se il decision tree modificato é valido o meno & \hyperref[uc:uc27]{UC27}\\
                \hline
                R-69-F-Op & L'Utente deve ricevere una segnalazione in seguito a degli errori nella modifica di un decision tree & \hyperref[uc:uc28]{UC28}\\
                \hline
                R-70-F-Op & L'Utente deve poter esportare il decision tree correttamente modificato & \hyperref[uc:uc29]{UC29}\\
                \hline
                R-71-F-Op & L'Utente deve poter accedere all'editor del documento di un dispositivo & \hyperref[uc:uc30]{UC30}\\
                \hline
                R-72-F-Op & L'Utente deve poter visualizzare i dati del dispositivo in modalitá modifica & \hyperref[uc:uc30.1]{UC30.1}\\
                \hline
                R-73-F-Op & L'Utente deve poter visualizzare la lista di assets del dispositivo con funzionalitá di seleziona e modifica & \hyperref[uc:uc31]{UC31}\\
                \hline
                R-74-F-Op & L'Utente deve poter selezionare l'asset da modificare & \hyperref[uc:uc32]{UC32}\\
                \hline
                R-75-F-Op & L'Utente deve poter modificare i dati dell'asset & \hyperref[uc:uc33]{UC33}\\
                \hline
                R-76-F-Op & L'Utente deve poter annullare la modifica dei dati dalle'asset & \hyperref[uc:uc34]{UC34}\\
                \hline
                R-77-F-Op & L'Utente deve poter confermare la modifica dei dati dell'asset & \hyperref[uc:uc35]{UC35}\\
                \hline
                R-78-F-Op & L'Utente deve poter salvare il documento modificato del dispositivo & \hyperref[uc:uc36]{UC36}\\
                \hline
                R-79-F-Op & L'Utente deve uscire dall'editor prima del salvataggio, riportando i dati del documento del dispositivo alla versione originale & \hyperref[uc:uc37]{UC37}\\
                \hline
            \end{longtable}
    }
    ...
    \subsection{Requisiti di qualità}{
        ...
        \rowcolors{2}{lightblue}{white}
            \begin{longtable}{|l|p{0.6\textwidth}|l|}
                ...
                \rowcolor{gold}
                \hline
                R-1-Q-Ob & È necessario rispettare tutte le norme presenti nelle \hyperref[]{Norme di Progetto ver. 1.0.0} & Interno \\ 
                \hline 
