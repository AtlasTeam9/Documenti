...
\newcommand{\VersioneDocumento}{v0.13.0} % <-- modifica qui la versione o ID
...
\section*{Registro delle modifiche}
    ...
    \rowcolors{2}{lightblue}{white} 
        \begin{tabularx}{\textwidth}{|l|l|l|X|X|}
            ...
            \hline
            \VersioneDocumento & 2026/01/28 & Francesco Marcolongo & Andrea Difino & Aggiunti diagrammi dei Casi d'Uso \\
            \hline
        ...
        \subsubsection{UC11 - Esportazione test completato} 
            ...
            \begin{itemize}
                ...
                \begin{itemize}
                    ...
                    \item Il Sistema formatta i dati del test e li rende disponibili in file nei formati:
                    \begin{itemize}
                        \item[a)] PDF
                        \item[b)] JSON
                    \end{itemize}
                ...
                \begin{itemize}
                    ...
                    \begin{itemize}
                        ...
                        \begin{itemize}
                            ...
                            \item[d)] la funzionalità [\hyperref[uc:uc12.1.3]{UC12.1.3}]
                            \item[e)] la descrizione [\hyperref[uc:uc12.1.4]{UC12.1.4}]
                        \end{itemize}
                    \end{itemize}
                    \item \textbf{Scenari alternativi}:
                    \begin{itemize}
