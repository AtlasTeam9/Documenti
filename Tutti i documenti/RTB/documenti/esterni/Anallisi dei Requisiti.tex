...
\newcommand{\DataUltimaModifica}{2026/01/11}
\newcommand{\LogoGruppo}{../../../Assets/AtlasLogo.png} 

% --- Nuove variabili aggiunte ---
\newcommand{\VersioneDocumento}{v0.8.3} % <-- modifica qui la versione o ID
...
\section*{Registro delle modifiche}
    ...
    \rowcolors{2}{lightblue}{white} 
        \begin{tabularx}{\textwidth}{|l|l|l|X|X|}
            ...
            \hline
            \VersioneDocumento & \DataUltimaModifica & Riccardo Valerio & Andrea Difino & Iniziati requisiti funzionali da 26 a 41 \\
            \hline
            ...
            \noindent Il Caso d’Uso UC21 include un ulteriore Caso d’Uso come raffigurato nella seguente immagine:
                    ...
                    \begin{itemize}
                        ...
                        \begin{itemize}
                            ...
                            \item Il Sistema mostra per ciascun tree:
                            \begin{itemize}
                                \item id del requisito
                                \item titolo
                                \item dipendenze (se presenti)
                            \end{itemize}
                        \end{itemize}
                    \end{itemize}
    ...
    \subsection{Requisiti funzionali}{
        \rowcolors{2}{lightblue}{white}
            \begin{longtable}{|l|p{0.6\textwidth}|l|}
                ...
                \hline
                R-22-F-Ob & L'Utente deve poter caricare la domanda precedente durante l'esecuzione di un test se non si é alla prima & \hyperref[uc:uc7]{U7}\\
                \hline
                R-23-F-Ob & L'Utente deve poter modificare una domanda a cui ha precedentemente risposto & \hyperref[uc:uc7]{U7}\\
                \hline
                R-24-F-Ob & L'Utente deve poter caricare la domanda successiva durante l'esecuzione di un test se é stato prima selezionato il pulsante per tornare alla domanda precedente & \hyperref[uc:uc8]{UC8}\\
                \hline
                R-25-F-Ob & L'Utente deve poter uscire dal test in qualsiasi momento della sua esecuzione & \hyperref[uc:uc9]{UC9}\\
                \hline
                R-26-F-Ob & L'Utente deve ricevere un salvataggio del test parziale nel caso in cui esca da un test durante la sua esecuzione & \hyperref[uc:uc9.1]{UC9.1}\\
                \hline
                R-27-F-Ob & L'Utente deve poter inserire manualmente i dati di un dispositivo & \hyperref[uc:uc10]{UC10}\\
                \hline
                R-28-F-Ob & L'Utente deve poter visualizzare il form per l'inserimento dei dati del dispositivo & \hyperref[uc:uc10.1]{UC10.1}\\
                \hline
                R-29-F-Ob & L'Utente deve poter inserire il nome del dispositivo nell'apposito form di creazione & \hyperref[uc:uc10.1.1]{UC10.1.1}\\
                \hline
                R-30-F-Ob & L'Utente deve poter inserire il sistema operativo del dispositivo nell'apposito form di creazione & \hyperref[uc:uc10.1.2]{UC10.1.2}\\
                \hline
                R-31-F-Ob & L'Utente deve poter inserire la versione del firmware del dispositivo nell'apposito form di creazione & \hyperref[uc:uc10.1.3]{UC10.1.3}\\
                \hline
                R-32-F-Ob & L'Utente deve poter inserire le funzionalitá del dispositivo nell'apposito form di creazione & \hyperref[uc:uc10.1.4]{UC10.1.4}\\
                \hline
                R-33-F-Ob & L'Utente puó inserire la descrizone del dispositivo nell'apposito form di creazione & \hyperref[uc:uc10.1.5]{10.1.5}\\
                \hline
                R-34-F-Ob & L'Utente deve poter salvare il form per l'inserimento manuale dei dati del dispositivo & \hyperref[uc:uc11]{11}\\
                \hline
                R-35-F-Ob & L'Utente deve poter inserire manualmente gli asset del dispositivo & \hyperref[uc:uc12]{12}\\
                \hline
                R-36-F-Ob & L'Utente deve poter visualizzare il form per l'inserimento dei dati di un singolo asset & \hyperref[uc:uc12.1]{12.1}\\
                \hline
                R-37-F-Ob & L'Utente deve poter inserire il nome dell'asset nel form apposito & \hyperref[uc:uc12.1.1]{12.1.1}\\
                \hline
                R-38-F-Ob & L'Utente deve poter scegliere il tipo dell'asset nel form apposito & \hyperref[uc:uc12.1.2]{12.1.2}\\
                \hline
                R-39-F-Ob & L'Utente puó inserire la descrizione dell'asset nel form apposito & \hyperref[uc:uc12.1.3]{12.1.3}\\
                \hline
                R-40-F-Ob & L'Utente deve poter inserire la sensibilitá dell'asset nel form apposito & \hyperref[uc:uc12.1.4]{12.1.4}\\
                \hline
                R-41-F-Ob & L'Utente deve poter salvare il form per la creazione manuale dell'asset & \hyperref[uc:uc13]{13}\\
                \hline
            \end{longtable}
    }
