...
\newcommand{\VersioneVerbale}{v0.2.0} % <-- modifica qui la versione o ID
...
\section*{Registro delle modifiche}{
    \begin{center} 
        \begin{tabular}{|l|l|l|l|l|}
            ...
            \hline
            \VersioneVerbale & \DataVerbale & Giacomo Giora & Francesco Marcolongo & Sistemazione contenuto \\
            \hline
...
\section{Discussione}{
    ...
    \subsection{Creazione project board su Github}{
        È stata creata una project board su Github per migliorare la gestione delle attività e il monitoraggio del progresso del progetto, discutendo su quante e quali fasi creare, e su come gestire le dipendenze tra di esse.
    }
...
\section{Decisioni Prese}{
    ...
    \begin{tabular}{|c|p{11cm}|}
        ...
        \hline
            D2-07/11/2025 & Deciso che il nuovo sistema di versionamento sarà nella forma X.Y.Z. \\
		\hline
			D3-07/11/2025 & Creata la project board su Github. \\
		\hline
    \end{tabular}
    \end{center}
}
