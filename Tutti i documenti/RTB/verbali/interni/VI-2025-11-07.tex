...
\newcommand{\VersioneVerbale}{v0.3.0} % <-- modifica qui la versione o ID
...
\section*{Registro delle modifiche}{
    \begin{center}
        \begin{tabular}{|l|l|l|l|l|}
            ...
            \hline
            \VersioneVerbale & \DataVerbale & Federico Simonetto & Francesco Marcolongo & Aggiunta ruoli e \\
            & & & & tabella azioni \\
            \hline
...
\section{Decisioni Prese}{
    ...
    \begin{tabular}{|c|p{11cm}|}
        ...
        \hline
            D\{1\}-07/11/2025\_vi &  Definiti i seguenti ruoli per il primo sprint: Responsabile - Andrea Difino, Amministratore - Michele Tesser, Analista - Giacomo Giora e Bilal Sabic, Progettista - Riccardo Valerio e Federico Simonetto, Verificatore - Francesco Marcolongo.\\
        \hline
            D\{2\}-07/11/2025\_vi & Deciso che il nuovo sistema di versionamento sarà nella forma X.Y.Z. \\
		\hline
			D\{3\}-07/11/2025\_vi & Deciso l'utilizzo di una project board su Github per migliorare la gestione delle attività. \\
		\hline
    \end{tabular}
    \end{center}
}
...
\section{Attivitá da svolgere}{
    ...
    \begin{tabular}{|c|p{4.5cm}|c|p{3cm}|} 
        ...
        \hline
            A\{1\}-07/11/2025\_vi &  Creare la project board su GitHub. & - & Andrea Difino \\
        \hline
            A\{2\}-07/11/2025\_vi & Modificare il way of \newline working. & - & Francesco \newline Marcolongo \\
        \hline
            A\{3\}-07/11/2025\_vi & Stesura iniziale del \newline glossario. & - & Team \\
        \hline
    \end{tabular}
    \end{center}
}
