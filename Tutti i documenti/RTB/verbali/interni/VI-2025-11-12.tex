...
\section*{Registro delle modifiche}{
	...
	\hline
	\VersioneVerbale&2025/11/18&Bilal Sabic & Federico Simonetto&Versione definitiva \\
	\hline
	v.0.1.1&\DataVerbale &Bilal Sabic & Francesco Marcolongo&Piccole correzioni \\
    \hline
    v0.1.0&\DataVerbale &Bilal Sabic & Francesco Marcolongo&Prima stesura \\
    \hline
        \end{tabular}
    \end{center}
}
...
\section{Discussione}{
	...
	Il gruppo ha discusso del way of working e delle possibili modalità per ottimizzarlo, insieme a proposte di miglioramento riguardanti la struttura della repository GitHub. In particolare si è discusso sul problema della concorrenza. 
	}
...
\section{Decisioni prese}{
    ...
    \begin{tabular}{|c|p{12cm}|}
        ...
        \hline
            D1-\DataVerbale\_vi & Ridefinita la struttura della repo per risolvere il problema della concorrenza  \\
        \hline
	D2-\DataVerbale\_vi & Deciso Telegram come canale di comuncazione con l'azienda \\
        \hline
    \end{tabular}
    \end{center}
}
...
\section{Attivitá da svolgere}{
    ...
    \begin{tabular}{|c|p{4.5cm}|c|p{3cm}|} 
        ...
        \hline
            A1-\DataVerbale\_vi & Definire quali tecnologie utilizzare per il \newline progetto  & -  & Team \\
        \hline
	 A2-\DataVerbale\_vi & Continuare a scrivere il glossario  & -  & Team \\
        \hline
	A3-\DataVerbale\_vi & Studiare la documentazione condivisa \newline dall'azienda  & -  & Team \\
        \hline
    \end{tabular}
    \end{center}
}
