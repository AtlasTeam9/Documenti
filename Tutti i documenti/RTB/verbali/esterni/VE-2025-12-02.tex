...
\section*{Registro delle modifiche}{
    \begin{center} 
        ...
        \hline
            ...
            \hline
            \VersioneVerbale & 2025/12/02 & Federico Simonetto & Bilal Sabic, Michele Tesser & Firma del documento \\
            \hline
            v0.1.0 & 2025/12/02 & Federico Simonetto &  & Prima stesura \\
            \hline
        \end{tabular}
    \end{center}
}
...
\section{Discussione}{
    ...
    % ----------------------------------------------------
    \subsection{Supervisione casi d'uso}
...
\section{Decisioni prese}{
    ...
    \begin{tabular}{|c|p{12cm}|}
        ...
        \hline
            D2-\DataVerbale\_ve & Deciso utilizzo di Git come software di versionamento per il prodotto software \\
        \hline
    \end{tabular}
    \end{center}
}
