...
In questo verbale vengono riportati gli argomenti discussi, le domande poste e le risposte ricevute, durante il secondo meeting effettuato del team \Gruppo \space con l'azienda \textbf{Bluewind S.r.l.}, del gruppo nel giorno \DataVerbale \space dalle \OraInizio \space alle \OraFine.
}
...
\section*{Registro delle modifiche}{
    \begin{center} 
        \begin{tabular}{|l|l|l|l|l|}
            ...
            % & & & & \\
            %\hline
            \VersioneVerbale & 2025/11/11 & Federico Simonetto & Francesco Marcolongo & Prima stesura \\
            \hline
        \end{tabular}
    \end{center}
}
...
\section{Discussione}{
    ...
    \textbf{Risposta:} Viene lasciata molta libertà nella scelta delle tecnologie. Le principali caratteristiche che il prodotto software dovrà possedere sono modularità, comprensibilità e 
    documentabilità. Viene imposta la persistenza dei dati: in caso di riavvio dell'applicazione, l'utente deve poter ricaricare il progetto su cui stava lavorando. Questo 
    ...
    \textbf{Risposta:} Viene fornito un link al cloud aziendale dove sono presenti la documentazione RED EN18031 e gli standard che dovranno essere implementati nonché il caso d'uso 
    della Macchina del Caffè menzionato nel capitolato di presentazione.

    % ----------------------------------------------------

    \subsection{Frequenza degli incontri con l'azienda proponente}
    \textbf{Domanda:} Quanto spesso verranno svolti gli incontri tra il team Atlas e l'azienda proponente? E secondo quali modalità?
    ...
    potranno avere cadenza bisettimanale aumentando successivamente durante la fase di codifica del prodotto. È stato inoltre deciso di utilizzare Telegram come canale di comunicazione aggiuntivo per poter ricevere feedback
    ...
    \textbf{Risposta:} Inizialmente, l'utente fornisce le informazioni sul dispositivo tramite file. L'applicazione presenta le domande dai decision tree, l'utente interagisce tramite le risposte che verranno poi salvate e analizzate per generare un output preciso. 
    ...
    Le domande all'interno dei decision tree devono essere presentate con una sequenza logica ben definita
    poichE la risposta ad alcuni requisiti abilita domande relative ad altri requisiti.
...
\section{Decisioni prese}{
    ...
    \begin{tabular}{|c|p{12cm}|}
        ...
        \hline
            D\{1\}-\DataVerbale\_ve & Condivisione da parte dell'azienda proponente di documenti riguardanti il capitolato, finalizzata ad attività di studio. \\
        \hline
            D\{2\}-\DataVerbale\_ve & Fissata nuova riunione tramite Google Meet con l'azienda Bluewind S.r.l. in data 2025/11/08. \\
        \hline 
            D\{3\}-\DataVerbale\_ve & Decisa la creazione di un gruppo Telegram per poter contattare in modo istantaneo l'azienda proponente.\\    
        \hline
    \end{tabular}
    \end{center}
}
...
\section{Attivitá da svolgere}{
    ...
    \begin{tabular}{|c|p{4.5cm}|c|p{3cm}|} 
        ...
        \hline
            A\{1\}-\DataVerbale\_ve &  Iniziare lo studio dello standard RED e dei decision tree. & - & Team \\
        \hline
            A\{2\}-\DataVerbale\_ve & Brainstorming per iniziare a decidere le tecnologie da utilizzare. & - & Team \\
        \hline
            A\{3\}-\DataVerbale\_ve & Creare il gruppo Telegram per effettuare contatto istantaneo con l'azienda proponente. & - & Andrea Difino \\
        \hline
    \end{tabular}
    \end{center}
}
