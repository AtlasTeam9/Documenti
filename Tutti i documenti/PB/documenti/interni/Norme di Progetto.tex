...
\newcommand{\DataUltimaModifica}{2026/03/12}
\newcommand{\LogoGruppo}{../../../Assets/AtlasLogo.png}

% --- Nuove variabili aggiunte ---
\newcommand{\VersioneDocumento}{1.0.1}
...
\section*{Registro delle modifiche}{
    ...
    \rowcolors{2}{lightblue}{white} % Alternanza automatica dal secondo row
        \begin{tabularx}{\textwidth}{|l|l|l|l|X|}
            ...
            \hline
            v.1.0.1 & \DataUltimaModifica & Bilal Sabic & Federico Simonetto & Modifiche migliorative \\
            \hline
...
\section{Introduzione}{
    \subsection{Scopo del documento}{
        Lo scopo del \textit{Norme di Progetto} è definire le procedure e gli strumenti di lavoro che il team utilizzerà per tutta la durata del progetto didattico.
        \newline
...
\section{Processi di supporto}
    ...
    \subsection{Gestione delle configurazioni}
        ...
        \subsubsection{Valutazione della configurazione}
            ...
            \href{https://atlasteam9.github.io/Atlas/docs/RTB/documenti/esterni/Analisi%20dei%20Requisiti.pdf}{Analisi dei Requisiti v1.1.0}.
    ...
    \subsection{Accertamento della qualità}
        ...
        Le metriche individuate dal team di progetto sono descritte in modo dettagliato sia nel documento \href{https://atlasteam9.github.io/Atlas/docs/RTB/documenti/esterni/Piano%20di%20Qualifica.pdf}{Piano di Qualifica v1.0.0} sia nelle sezioni~\ref{sec:mpc} e \ref{sec:mpd} del documento attuale.
