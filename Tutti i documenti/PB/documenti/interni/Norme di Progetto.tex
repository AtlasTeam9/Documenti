...
\newcommand{\DataUltimaModifica}{2026/04/07}
\newcommand{\LogoGruppo}{../../../Assets/AtlasLogo.png}

% --- Nuove variabili aggiunte ---
\newcommand{\VersioneDocumento}{v2.0.0}
...
\section*{Registro delle modifiche}{
    ...
    \rowcolors{2}{lightblue}{white} % Alternanza automatica dal secondo row
        \begin{tabularx}{\textwidth}{|l|l|l|l|X|}
            ...
            \hline
            \VersioneDocumento & \DataUltimaModifica & Giacomo Giora & Michele Tesser & Approvazione documento\\
            \hline
            v1.1.2 & 2026/03/13 & Bilal Sabic & Federico Simonetto & Modificati riferimenti normativi\\
            \hline
            v1.1.1 & 2026/03/12 & Bilal Sabic & Federico Simonetto & Modifiche migliorative \\
            \hline 
            v1.1.0 & 2026/03/08 & Bilal Sabic & Federico Simonetto & Aggiunta sezione progettazione \\
            \hline
...
\section{Processi primari}{
    ...
    \newline
    Sebbene cinque processi siano classificati come primari, in questo approfondiremo i processi di \textbf{fornitura} e di \textbf{sviluppo}, più interessanti dal punto di vista del progetto didattico.
    ...
    \subsection{Fornitura}{
        ...
        \subsubsection{Documentazione fornita}{
            ...
            \begin{tabularx}{\textwidth}{|l|X|}
                ...
                \hline
                \textbf{Scopo e contenuti} & Il riporta l'elenco dei Casi d'Uso (con relativi diagrammi UML)  degli attori coinvolti, i requisiti, funzionali e non, collegati ai Casi d'Uso e al capitolato, e le informazioni relative al loro tracciamento.\\
                \hline
            \end{tabularx}
            \caption{Descrizione del "Analisi dei requisiti"}
            \end{table}
            }
            ...
            \begin{tabularx}{\textwidth}{|l|X|}
                ...
                \textbf{Tipo di documento} & Esterno\\
                \hline
                \textbf{Scopo e contenuti} & Il ha come scopo la presentazione ufficiale ai prof. Vardanega e Cardin della candidatura del team alle baseline di progetto.\\
                \hline
            \end{tabularx}   
            \caption{Descrizione del "Lettera di presentazione"}
            \end{table}
            } 
            ...
            \begin{tabularx}{\textwidth}{|l|X|}
                ...
                \hline
                \textbf{Scopo e contenuti} & attuale, riporta gli strumenti e le procedure che il team utilizzerà per tutto lo sviluppo del progetto didattico. \\
                \hline
            \end{tabularx}      
            \caption{Descrizione del "Norme di progetto"}
            \end{table}
            }
            ...
            \rowcolors{2}{lightblue}{white}
                \begin{tabularx}{\textwidth}{|l|X|}
                    ...
                    \textbf{Tipo di documento} & Esterno\\
                    \hline
                    \textbf{Scopo e contenuti} & Lo scopo del è tracciare le attività che vengono svolte così come quelle che vengono pianificate durante tutta la realizzazione del progetto. Il \textit{Piano di progetto} riporta una descrizione di ogni sprint con l'aggiornamento delle ore utilizzate e i relativi costi.\\
                    \hline
                \end{tabularx}     
            \caption{Descrizione del "Piano di progetto"}
            \end{table}
            }
            ...
            \rowcolors{2}{lightblue}{white}
                \begin{tabularx}{\textwidth}{|l|X|}
                    ...
                    \textbf{Tipo di documento} & Esterno\\
                    \hline
                    \textbf{Scopo e contenuti} & Il riporta le strategie di verifica e di validazione che il team di progetto utilizzerà per garantire la qualità del prodotto e dei processi del progetto, oltre ai test effettuati e i rispettivi esiti.\\
                    \hline
                \end{tabularx}    
            \caption{Descrizione del "Piano di qualifica"}
            \end{table}
            }  
        }
    }
    ...
    \label{subsec:sviluppo}{
        ...
        \subsubsection{Progettazione del prodotto software}
            L'attività di progettazione è svolta dai progettisti e consiste nell'implementazione dell'architettura software a partire dai requisiti definiti nella fase di analisi. In primo luogo, vengono individuate le tecnologie da utilizzare, specificandone riferimenti e versioni. Successivamente si procede con la progettazione vera e propria, partendo dalla definizione dell'architettura logica e di deployment, per poi scendere progressivamente nel dettaglio fino a delineare le singole unità che costituiranno il prodotto finale.
            \\
            Si tratta di un'attività collaborativa, organizzata in gruppi di lavoro, con l'obiettivo di favorire il confronto tra diversi punti di vista e convergere infine verso una sintesi delle soluzioni migliori.\\
            Attraverso l'adozione di buone pratiche e l'utilizzo di appropriati design pattern, si mira a realizzare un'architettura non solo funzionale, ma anche scalabile, estendibile e manutenibile nel tempo, così da facilitare eventuali evoluzioni o modifiche future.\\
            In parallelo, vengono definiti i test che saranno successivamente eseguiti, al fine di garantire la conformità del prodotto alle specifiche e supportare il team nell'individuazione tempestiva di eventuali problematiche.
            \\
            Tutte le descrizioni delle tecnologie e dell'architettura sono visionabili nell'apposito documento \href{https://atlasteam9.github.io/Atlas/docs/PB/documenti/esterni/Specifica%20Tecnica.pdf}{Specifica Tecnica v1.0.0}.

            \paragraph{Strumenti e tecnologie}\mbox{}\\
                Strumento utilizzato per la progettazione
                \begin{itemize}
                    \item \textbf{Draw.io}: applicazione web utilizzata per svolgere in modo contemporaneo e collaborativo il diagramma delle classi.
                \end{itemize}
...
\section{Processi di supporto}
    ...
    \subsection{Gestione delle configurazioni}
        ...
        \subsubsection{Valutazione della configurazione}
            ...
            \href{https://atlasteam9.github.io/Atlas/docs/PB/documenti/esterni/Analisi%20dei%20Requisiti.pdf}{Analisi dei Requisiti v2.0.0}.
    ...
    \subsection{Accertamento della qualità}
        ...
        Le metriche individuate dal team di progetto sono descritte in modo dettagliato sia nel documento \href{https://atlasteam9.github.io/Atlas/docs/PB/documenti/esterni/Piano%20di%20Qualifica.pdf}{Piano di Qualifica v2.0.0} sia nelle sezioni~\ref{sec:mpc} e \ref{sec:mpd} del documento attuale.
    ...
    \subsection{Processi organizzativi}
        ...
        \subsubsection{Gestione dei processi}
            ...
            \begin{tabularx}{\textwidth}{|l|X|}
                ...
                \textbf{Codice} & MPC18\\
                \hline
                \textbf{Descrizione} & L'indice \textbf{Non-Calculated Risk} rappresenta il numero di rischi non previsti che si sono manifestati durante lo svolgimento del progetto. \\
                \hline
            \end{tabularx}      
    ...
    \subsection{Funzionalità}
        {\renewcommand{\arraystretch}{1.4}
            ...
            \begin{tabularx}{\textwidth}{|l|X|}
                \hline
                \rowcolor{gold}
                \multicolumn{2}{|c|}{\textbf{Requisiti Obbligatori Soddisfatti}}\\
                \hline
                \textbf{Codice} & MPD01 \\
                \hline
                \raisebox{0.6\height}{\textbf{Formula}} &  \rule{0pt}{5ex}\raisebox{0.3\height}{\( \displaystyle \text{Requisiti Obbligatori Soddisfatti} = \frac{\text{Requisiti obbligatori soddisfatti}}{\text{Requisiti obbligatori totali}}*100 \)}\\
                \hline
                \textbf{Descrizione} & La metrica \textbf{Requisiti Obbligatori Soddisfatti} rappresenta la percentuale dei requisiti obbligatori soddisfatti sul totale dei requisiti obbligatori individuati.\\
                \hline
            \end{tabularx}      
            \caption{Descrizione della metrica "Requisiti Obbligatori Soddisfatti"}
            \end{table}
        }
        ...
        {\renewcommand{\arraystretch}{1.4}
            ...
            \begin{tabularx}{\textwidth}{|l|X|}
                \hline
                \rowcolor{gold}
                \multicolumn{2}{|c|}{\textbf{Requisiti Desiderabili Soddisfatti}}\\
                \hline
                \textbf{Codice} & MPD02 \\
                \hline
                \raisebox{0.6\height}{\textbf{Formula}} &  \rule{0pt}{5ex}\raisebox{0.3\height}{\( \displaystyle \text{Requisiti Desiderabili Soddisfatti} = \frac{\text{Requisiti desiderabili soddisfatti}}{\text{Requisiti desiderabili totali}}*100 \)}\\
                \hline
                \textbf{Descrizione} & La metrica \textbf{Requisiti Desiderabili Soddisfatti} rappresenta la percentuale dei requisiti desiderabili soddisfatti sul totale dei requisiti desiderabili individuati.\\
                \hline
            \end{tabularx}      
            \caption{Descrizione della metrica "Requisiti Desiderabili Soddisfatti"}
            \end{table}
        }
        ...
        {\renewcommand{\arraystretch}{1.4}
            ...
            \begin{tabularx}{\textwidth}{|l|X|}
                \hline
                \rowcolor{gold}
                \multicolumn{2}{|c|}{\textbf{Requisiti Opzionali Soddisfatti}}\\
                \hline
                \textbf{Codice} & MPD03 \\
                \hline
                \raisebox{0.6\height}{\textbf{Formula}} &  \rule{0pt}{5ex}\raisebox{0.3\height}{\( \displaystyle \text{Requisiti Opzionali Soddisfatti} = \frac{\text{Requisiti opzionali soddisfatti}}{\text{Requisiti opzionali totali}}*100 \)}\\
                \hline
                \textbf{Descrizione} & La metrica \textbf{Requisiti Opzionali Soddisfatti} rappresenta la percentuale dei requisiti opzionali soddisfatti sul totale dei requisiti opzionali individuati.\\
                \hline
            \end{tabularx}      
            \caption{Descrizione della metrica "Requisiti Opzionali Soddisfatti"}
            \end{table}
        }
        ...
        {\renewcommand{\arraystretch}{1.4}
            ...
            \begin{tabularx}{\textwidth}{|l|X|}
                ...
                \textbf{Codice} & MPD11 \\
                \hline
                \raisebox{0.6\height}{\textbf{Formula}} &  \rule{0pt}{5ex}\raisebox{0.3\height}{\( \displaystyle \text{Coefficient of Coupling} = \frac{\text{Numero di dipendenze}}{\text{Numero di componenti}}\)}\\
                \hline
                \textbf{Descrizione} & La metrica \textbf{Coefficient of Coupling} rappresenta il numero di dipendenze tra i componenti del sistema. \\
                \hline
            \end{tabularx}      
        ...
        {\renewcommand{\arraystretch}{1.4}
            ...
            \begin{tabularx}{\textwidth}{|l|X|}
                ...
                \textbf{Codice} & MPD12 \\
                \hline
                \textbf{Formula} & \( \displaystyle \text{Cyclomatic complexity} = \text{E}-\text{N}+\text{P} \)\\
                \hline
                \textbf{Descrizione} & E rappresenta il numero di archi nel grafo di controllo del programma, N rappresenta il numero di nodi nel grafo, e P rappresenta il numero di componenti connesse. La metrica \textbf{Cyclomatic complexity} quantifica la complessità logica e strutturale del programma contando il numero di percorsi linearmente indipendenti attraverso il suo codice sorgente. \\
                \hline
            \end{tabularx}      
        ...
        {\renewcommand{\arraystretch}{1.4}
            ...
            \begin{tabularx}{\textwidth}{|l|X|}
                ...
                \textbf{Codice} & MPD13 \\
                \hline
                \textbf{Formula} & \( \displaystyle \text{Parametri(Metodo)} = \text{Numero di argomenti nella firma della funzione} \)\\
                \hline
                \textbf{Descrizione} & La metrica \textbf{Parametri per metodo} rappresenta il numero di argomenti presenti nella firma di ciascun metodo all'interno del progetto. \\
                \hline
            \end{tabularx}      
        ...
        {\renewcommand{\arraystretch}{1.4}
            ...
            \begin{tabularx}{\textwidth}{|l|X|}
                ...
                \textbf{Codice} & MPD14 \\
                \hline
                \textbf{Formula} & \( \displaystyle \text{Linee di codice(Metodo)} = \text{Linee di istruzioni nel metodo} \)\\
                \hline
                \textbf{Descrizione} & La metrica \textbf{Linee di codice per metodo} rappresenta una misura quantitativa della dimensione di ciascun metodo all'interno del progetto. \\
                \hline
            \end{tabularx}      
        ...
        {\renewcommand{\arraystretch}{1.4}
            ...
            \begin{tabularx}{\textwidth}{|l|X|}
                ...
                \textbf{Codice} & MPD15 \\
                \hline
                \textbf{Formula} & \( \displaystyle \text{Profondità delle gerarchie} = \text{Massima profondità delle gerarchie di classi} \)\\
                \hline
                \textbf{Descrizione} & La metrica \textbf{Profondità delle gerarchie} descrive l'equilibrio tra riutilizzo del codice e complessità strutturale. Rappresenta il livello massimo di profondità delle gerarchie di classi all'interno del progetto. \\
                \hline
            \end{tabularx}      
