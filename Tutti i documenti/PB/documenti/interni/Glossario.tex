...
\newcommand{\DataUltimaModifica}{2026/04/09}
...
\section*{Registro delle modifiche}
    ...
    \rowcolors{2}{lightblue}{white} % Alternanza automatica dal secondo row
        \begin{tabularx}{\textwidth}{|l|l|l|l|X|}
            ...
            \hline
            v2.0.0 & 2026/04/09 & Giacomo Giora & Michele Tesser & Approvazione documento \\
            \hline
            v1.1.0 & 2026/03/09 & Bilal Sabic & Federico Simonetto & Aggiunta termini \\
            \hline
...
\newpage      
        \section{C}
          ...
          \subsection*{CSV}
            Formato di file semplice usato per salvare dati in forma tabellare.
  ...
  \newpage    
        \section{D}
          ...
          \subsection*{Docker}
            Piattaforma che permette di creare, distribuire e far girare applicazioni in container, cioè ambienti isolati e leggeri che includono tutto il necessario per far funzionare un'app.
...
\newpage    
        \section{F}
          ...
          \subsection*{Firmware}
            Software di base integrato direttamente in un dispositivo hardware.
...
\newpage
        ...
        \section{V}
          ...
          \subsection*{Virtualizzazione}
            Tecnologia che permette di creare versioni “virtuali” di risorse informatiche (come computer, server, sistemi operativi o reti), così da usarle come se fossero reali su un unico dispositivo fisico.
