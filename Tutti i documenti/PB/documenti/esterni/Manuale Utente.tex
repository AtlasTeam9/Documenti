...
\section{Istruzioni per l'uso}
    ...
    \subsection{Caricamento di un dispositivo}
      ...
      \subsubsection{Visualizzazione degli asset}
        È presente un elemento cliccabile contenente il nome del dispositivo inserito; selezionandolo, viene visualizzata la lista di tutti gli asset del dispositivo. Ogni asset è rappresentato da un riquadro che mostra il nome e il tipo dell'asset.
        \begin{center}
        \begin{figure}[H]
              \centering
      ...
      \subsubsection{Visualizzazione dei dettagli degli asset}
        Premendo su un singolo asset nella lista degli asset, vengono visualizzati sullo schermo i suoi dettagli.
        \begin{center}
        \begin{figure}[H]
              \centering
      ...
      \subsection{Visualizzazione esito test}
        Al termine del test, per ogni requisito viene visualizzato sullo schermo l'esito. Gli esiti possono essere di quattro tipi: 
      \begin{itemize}
          \item \textbf{PASS}: per tutti gli asset del dispositivo il requisito è soddisfatto oppure in stato NON APPLICABILE. Tale requisito quindi è soddisfatto per il dispositivo.
          \item \textbf{FAIL}: per tutti gli asset del dispositivo il requisito è non soddisfatto oppure in stato NON APPLICABILE. Tale requisito quindi non è soddisfatto per il dispositivo.
          \item \textbf{NOT APPLICABLE}: per tutti gli asset del dispositivo il requisito è in stato NON APPLICABILE. Tale requisito quindi non è applicabile al dispositivo.
      ...
      \end{itemize}
      Il dispositivo soggetto al test viene considerato conforme alla normativa EN 18031 se tutti i requisiti sono soddisfatti o non applicabili. Se invece è presente almeno un requisito non soddisfatto, il dispositivo viene considerato non conforme.
       \begin{center}
        \begin{figure}[H]
              \centering
      ...
      \begin{itemize}
        ...
        \item selezionare il campo Type da una lista di opzioni predefinite,
      ...
      Una volta selezionato il pulsante \textbf{Modify Session} viene visualizzata la pagina di modifica con al suo interno la lista dei soli requisiti modificabili.
      \begin{center}
        \begin{figure}[H]
              \centering
      ...
      Per iniziare la modifica bisogna selezionare un asset specifico. Per visualizzare gli asset da cui è possibile modificare bisogna cliccare sul box corrispondente ad un requisito. Una volta cliccato si apre la lista degli asset da cui è possibile far ripartire l'esecuzione del test. 
      \begin{center}
        \begin{figure}[H]
              \centering
