...
\newcommand{\VersioneDocumento}{v1.2.1} % <-- modifica qui la versione o ID
...
\section*{Registro delle modifiche}
    ...
    \rowcolors{2}{lightblue}{white} % Alternanza automatica dal secondo row
        \begin{tabularx}{\textwidth}{|l|l|l|l|X|}
            ...
            \hline
            v1.2.1 & 2026/03/13 & Riccardo Valerio & Federico Simonetto & Correzione errori \\
            \hline
            v1.2.0 & 2026/03/12 & Riccardo Valerio & Federico Simonetto & Sistemazione ordine delle descrizioni degli sprint \\
            \hline
            v1.1.0 & 2026/03/10 & Riccardo Valerio & Federico Simonetto & Scrittura sez. pianificazione lungo termine e sistemazione contenuti \\
            \hline	
...
\section{Pianificazione a lungo termine}
	...
	A seguito dell'ultimo sprint della RTB, data la sottovalutazione dei ruoli Analista e Verificatore, è stata effettuata una riassegnazione delle ore per membro, risultata nella seguente disposizione:
    ...
    {\renewcommand{\arraystretch}{1.4}
        ...
        {\renewcommand{\arraystretch}{1.4}
		    ...
		    \begin{itemize}
			    ...
			    \item Miglioramento l'analisi delle metriche riportate;
        ...
        {\renewcommand{\arraystretch}{1.4}
		    ...
		    \textbf{Attività} & \textbf{Descrizione} & \textbf{Stato}\\
                \hline
		      \textbf{Realizzazione del MVP} & Codifica del Minimum Viable Product tramite codifica:
		    \begin{itemize}
			    \item
		    \end{itemize}
            e testing del prodotto come segnalato nel Piano di Qualifica v2.0.0 LINK!!!!		    & \textbf{} \\
                \hline
              \end{tabularx}      
            \end{table}
        }
