...
\section*{Registro delle modifiche}
    ...
    \rowcolors{2}{lightblue}{white} 
        \begin{tabularx}{\textwidth}{|l|l|l|l|X|}
            ...
            \hline
            \VersioneDocumento & \DataUltimaModifica & Giacomo Giora & Michele Tesser & Approvazione \\
            \hline
            v1.6.0 & 2026/04/07 & Francesco Marcolongo & Michele Tesser & Aggiunte ultime metriche \\
            \hline
            v1.5.0 & 2026/04/05 & Francesco Marcolongo & Michele Tesser & Aggiorate metriche con attività PB \\
            \hline
            v1.4.0 & 2026/04/02 & Andrea Difino & Federico Simonetto & Aggiunti test di Integrazione e di Unità del frontend \\
            \hline
...
\section{Strategie di testing}{
    ...
    \noindent Di seguito, sono elencati i test di tutte le tipologie. I test di sistema e i test di accettazione sono stati definiti durante lo svolgimento delle attività per la Requirements and Technology \textit{Baseline}\textsubscript{\href{https://atlasteam9.github.io/Atlas/glossario.html\#Baseline}{G}} (\textit{RTB}\textsubscript{\href{https://atlasteam9.github.io/Atlas/glossario.html\#RTB}{G}}). I test di unità, di integrazione e di regressione sono invece stati individuati durante lo svolgimento delle attività per la Product \textit{Baseline}\textsubscript{\href{https://atlasteam9.github.io/Atlas/glossario.html\#Baseline}{G}} (PB). \\\\
    ...
    \subsection{Test di unità}{
        I test di unità hanno come \textit{obiettivo}\textsubscript{\href{https://atlasteam9.github.io/Atlas/glossario.html\#Obiettivo}{G}} quello di accertare la copertura completa delle singole unità di codice (di solito metodi o funzioni) in isolamento. In questo modo si verifica la correttezza del codice al livello più elementare, controllando che ciascuna singola componente operi come previsto.
...
\section{Cruscotto di valutazione}{
    ...
    Vengono ora esposte le misurazioni eseguite durante il periodo intercorso tra l'aggiudicazione del \textit{capitolato}\textsubscript{\href{https://atlasteam9.github.io/Atlas/glossario.html\#Capitolato}{G}} e la Product \textit{Baseline}\textsubscript{\href{https://atlasteam9.github.io/Atlas/glossario.html\#Baseline}{G}} (PB).
    ...
    \subsection{MPC10: Requirements Stability Index}{
        ...
        \noindent \textbf{RTB:} \\
        Il Requirements Stability Index (RSI) ha un picco negativo allo 0\% nello sprint 1 in quanto il team ha iniziato fin da subito a individuare i requisiti. Dopo un aumento in corrispondenza dello sprint 2, si registrano ulteriori flessioni negative al di sotto del limite inferiore di accettabilità in corrispondenza degli sprint 3 e 4 (37\% e 29\%). Durante questi periodi, infatti, il team ha effettuato colloqui aggiuntivi con l'azienda proponente per analizzare in profondità il \textit{capitolato}\textsubscript{\href{https://atlasteam9.github.io/Atlas/glossario.html\#Capitolato}{G}} d'appalto e ha di conseguenza aggiunto e modificato diversi requisiti. Il valore diventa infine accettabile a partire dallo sprint 5. 
        \\\\
        \noindent \textbf{PB:} \\
        Durante le attività di questa \textit{baseline}\textsubscript{\href{https://atlasteam9.github.io/Atlas/glossario.html\#Baseline}{G}} si ha la stabilizzazione del RSI al di sopra della soglia inferiore di accettabilità. Nello sprint 7, il suo valore è di 89\% per via delle correzioni richieste dal prof. Cardin sull'Analisi dei Requisiti. Nei periodi 8 e 9 non si registrano cambiamenti e la metrica assume dunque valore ottimo. Nello sprint 10 il valore del RSI scende leggermente (a 96\%) a causa dell'adeguamento di alcuni requisiti agli scenari d'uso implementati nel progetto. Lo sprint 11 registra il ritorno della metrica al 100\%.
    }
    \newpage
    \subsection{MPC13: Indice di Gulpease}{
        ...
        \begin{itemize}[labelindent=0pt, leftmargin=*]
            \item L'Analisi dei Requisiti ha un valore sempre ottimo e in crescita, che raggiunge il massimo della \textit{RTB}\textsubscript{\href{https://atlasteam9.github.io/Atlas/glossario.html\#RTB}{G}} (88\%) nello sprint 6.
            \item Simile è l'andamento dell'indice del Piano di Progetto, con il valore 91\% nello sprint 6.
            \item Il Piano di Qualifica ha un indice sempre ottimo ma che decresce a partire dallo sprint 2 (il cui valore è 91\%).
            \item Le Norme di Progetto hanno un valore di leggibilità accettabile che raggiunge 79\% nello sprint 2 e che può dunque essere incrementato. 
            \item Il \textit{Glossario}\textsubscript{\href{https://atlasteam9.github.io/Atlas/glossario.html\#Glossario}{G}} è il documento meno leggibile con un indice di Gulpease stabile al 63\%, legato alla presenza di termini tecnici e frasi brevi.
        \end{itemize}
        ...
        \begin{itemize}[labelindent=0pt, leftmargin=*]
            ...
            \item Il \textit{Glossario}\textsubscript{\href{https://atlasteam9.github.io/Atlas/glossario.html\#Glossario}{G}} si mantiene stabile intorno al 63\%, confermandosi il documento meno leggibile a causa della natura tecnica dei contenuti.
    ...
    \subsection{MPC14: Correttezza ortografica}{
        ...
        \noindent \textbf{RTB:} \\
        Al termine dei primi due sprint non sono stati rilevati errori ortografici. Al termine degli sprint 3 sono invece stati trovati 2 errori nell'Analisi dei Requisiti e 1 nelle Norme di Progetto. In questo periodo, tali documenti sono cresciuti molto in dimensione. Nello sprint 4, è stato segnalato un \textit{errore}\textsubscript{\href{https://atlasteam9.github.io/Atlas/glossario.html\#Errore}{G}} nel Glossario. Negli sprint 5 e 6, il team ha raggiunto il valore ottimo grazie a revisioni più attente.
        \\\\
        \noindent \textbf{PB:} \\
        Negli sprint dal 7 all’11, la correttezza ortografica rimane complessivamente elevata, con un numero di errori contenuto e sempre entro il limite accettabile. Nello sprint 7 non vengono rilevati errori, confermando il mantenimento del valore ottimo raggiunto negli sprint precedenti. Gli sprint 8 e 9 registrano un \textit{errore}\textsubscript{\href{https://atlasteam9.github.io/Atlas/glossario.html\#Errore}{G}} ciascuno, di cui quello nel Manuale Utente è dovuto alla recente introduzione del documento. Nello sprint 10 si rilevano due errori nella Specifica Tecnica e uno nell'Analisi dei Requisiti, rappresentando il punto di maggiore criticità del periodo, pur rimanendo entro i limiti accettabili. Nello sprint 11 il team recupera completamente, riportando tutti i documenti a zero errori e ristabilendo il valore ottimo grazie a un'attività di \textit{revisione}\textsubscript{\href{https://atlasteam9.github.io/Atlas/glossario.html\#Revisione}{G}} finale accurata.
    ...
    \subsection{MPC15: Code coverage}{
        \begin{figure}[H]
            \centering
            \fbox{\includegraphics[scale=0.65]{../../../Assets/Grafici/CodeCoverage.png}}
    ...
    \subsection{MPC16: Test Success Rate}{
        \begin{figure}[H]
            \centering
            \fbox{\includegraphics[scale=0.65]{../../../Assets/Grafici/TestSuccessRate.png}}
        ...
        \\\\
        \noindent \textbf{PB:} \\
        Nello sprint 8 il Test Success Rate assume valore ottimo (100\%), segnale di una positiva introduzione dei test. Nei due sprint successivi si registrano due valori non ottimi (rispettivamente 96\% e 92\%), dovuti all'introduzione di diversi test più stringenti, soprattutto lato frontend. Nello Sprint 11, la metrica torna al 100\%, allineandosi pienamente al valore ottimale.
    }
    \newpage
    \subsection{MPC17: Quality Metrics Satisfied}{
        ...
        \\\\
        \noindent \textbf{PB:} \\
        Si nota un peggioramento della metrica nello sprint 7, in cui il valore scende sotto la soglia ottimale portandosi al 74\%. Questo calo è dovuto all'introduzione di nuove metriche, in particolare quelle di coverage, difficili da soddisfare nelle prime fasi di vita del progetto. Negli sprint successivi si ha però una graduale ripresa e il valore torna stabilmente sopra la soglia di accettabilità. L'eccezione di questo trend è rappresentata dallo sprint 10, in cui le metriche soddisfatte scendono al 78\% a causa dell'aggiunta di nuovo codice poco coperto da test. Allo sprint 11, questa metrica non arriva al valore ottimo, ma si ferma al 96\% in quanto non viene superata la soglia di accettabilità dei code smells.
    }
    \newpage
    \subsection{MPC18: Non Calculated Risk}{
        ...
        \noindent \textbf{RTB:} \\
        Non si sono mai presentati rischi non attesi durante gli sprint della RTB. Ciò significa che il team è riuscito a individuare efficacemente e sapientemente i rischi all'inizio della \textit{RTB}\textsubscript{\href{https://atlasteam9.github.io/Atlas/glossario.html\#RTB}{G}} e prima di ogni nuovo sprint e che si è adoperato fin da subito per cercare di mitigarli.
        \\\\
        \noindent \textbf{PB:} \\
        Anche durante gli sprint della PB il team non si è imbattuto in rischi non previsti. Risulta pertanto confermata l'\textit{efficacia}\textsubscript{\href{https://atlasteam9.github.io/Atlas/glossario.html\#Efficacia}{G}} dell'analisi iniziale svolta sulla loro individuazione e mititgazione.
    }
    \newpage
    \subsection{MPD01: Requisiti obbligatori soddisfatti}{
        \begin{figure}[H]
            \centering
            \fbox{\includegraphics[scale=0.65]{../../../Assets/Grafici/RequisitiObbligatoriSoddisfatti.png}}
        ...
        \\\\
        \noindent \textbf{PB:} \\
        La metrica di soddisfacimento dei requisiti obbligatori sale di poco nello sprint 7 (circa 4\%) dal momento che questo periodo è stato dedicato più alla progettazione architetturale del MVP che alla scrittura di molto codice. Ad ogni modo, il valore cresce progressivamente negli sprint successivi, per arrivare al 46\% al termine dello sprint 9. La maggiore crescita in termini implementativi si registra però nello sprint 10, durante il quale sono completati 22 requisiti obbligatori e la metrica raggiunge complessivamente il 78\%. Alla fine dello sprint 11, tutti i requisiti obbligatori risultano completati e la metrica assume valore ottimo.
    }
    \newpage
    \subsection{MPD02 e MPD03: Requisiti desiderabili soddisfatti e Requisiti opzionali soddisfatti}{
        \begin{figure}[H]
            \centering
            \fbox{\includegraphics[scale=0.65]{../../../Assets/Grafici/RequisitiDesiderabiliOpzionaliSoddisfatti.png}}
        ...
        \\\\
        \noindent \textbf{PB:} \\
        Dal grafico emerge che i requisiti desiderabili sono stati sviluppati interamente durante lo sprint 10. Si tratta infatti di 5 requisiti che hanno richiesto poco tempo di lavoro. Anche i requisiti opzionali sono stati presi in considerazione a partire da questo sprint, ma non sono stati completati per via della mancanza di tempo ulteriore. Allo sprint 11 ne risultano infatti soddisfatti il 17\%.
    }
    \newpage
    \subsection{MPD04: Branch coverage}{
        \begin{figure}[H]
            \centering
            \fbox{\includegraphics[scale=0.65]{../../../Assets/Grafici/BranchCoverage.png}}
        ...
        \\\\
        \noindent \textbf{PB:} \\
        Dallo sprint 8 si osserva un primo incremento del \textit{branch}\textsubscript{\href{https://atlasteam9.github.io/Atlas/glossario.html\#Branch}{G}} coverage (21\%), seguito da una crescita significativa nello sprint 9 (66\%), dove viene superato il limite accettabile (60\%), segno di un miglioramento concreto nella qualità dei test. Nello sprint 10 si registra una flessione al 50\%, dovuta all'introduzione di nuova logica con varie istruzioni condizionali non adeguatamente testate. Infine, nello sprint 11 il valore raggiunge circa l’80\%, raggiungendo il livello ottimo e indicando una buona copertura dei rami decisionali nelle fasi finali del progetto.
    }
    \newpage
    \subsection{MPD05: Statement coverage}{
        \begin{figure}[H]
            \centering
            \fbox{\includegraphics[scale=0.65]{../../../Assets/Grafici/StatementCoverage.png}}
        ...
        \\\\
        \noindent \textbf{PB:} \\
        Lo statement coverage ha valore 40\% nello sprint 8. La crescita prosegue rapidamente nello sprint 9, dove il valore raggiunge il doppio, l’80\%, superando la soglia minima accettabile. Nel corso dello sprint 10 la metrica diminuisce però al 63\%, valore che soddisfa poco il team trattandosi della copertura complessiva delle istruzioni. In compenso, durante lo sprint 11, la copertura degli statements sale fino al 92\% e arriva così nella regione dei valori ottimi.
    }
    \newpage
    \subsection{MPD10: Code smells}{
        \begin{figure}[H]
            \centering
            \fbox{\includegraphics[scale=0.65]{../../../Assets/Grafici/CodeSmells.png}}
            \caption{Grafico per sprint di MPD10}
        \end{figure}
        ...
        \\\\
        \noindent \textbf{PB:} \\
        Al termine dello sprint 8 non risultano esserci code smells. Nello sprint 9 ne vengono contati 13 (il valore massimo tollerabile è 10). Allo sprint 10 si ha però un aumento molto significativo, con un picco di 35, superando ampiamente la soglia accettabile: ciò rappresenta una fase di accumulo di debito tecnico dovuta all'introduzione rapida di nuove funzionalità. La presa di consapevolezza di questo problema emerge chiaramente nell'ultimo sprint, durante il quale il team ha eseguito un'attività di refactoring e miglioramento della qualità del codice e ha ridotto così il numero di code smells a 11. Nel complesso, la metrica evidenzia una criticità improvvisa ma parzialmente rientrata nella fase finale del progetto, seppur non ancora pienamente soddisfacente.
    }
    \newpage
    \subsection{MPD12: Cyclomatic complexity}{
        \begin{figure}[H]
            \centering
            \fbox{\includegraphics[scale=0.65]{../../../Assets/Grafici/CyclomaticComplexity.png}}
            \caption{Grafico per sprint di MPD12}
        \end{figure}
        ...
        \\\\
        \noindent \textbf{PB:} \\
        Nello sprint 7, il valore di complessità ciclomatica risulta essere basso in quanto durante questo periodo il progetto è stato solo iniziato. 
        A partire dallo sprint 8 si registra un aumento della metrica che si porta intorno a valori compresi tra circa 1,3 e 1,5. Questo incremento indica l'introduzione di una logica più articolata nel codice. Negli sprint successivi, la complessità si mantiene sostanzialmente stabile in questo intervallo. Nel complesso, i valori rimangono sempre ampiamente al di sotto delle soglie indicate nel grafico (sia quella ottimale sia quella di attenzione), evidenziando che il progetto conserva una complessità bassa e ben sotto controllo per tutta la sua evoluzione.

    }
    \newpage
    \subsection{MPD14: Linee di codice per metodo}{
        \begin{figure}[H]
            \centering
            \fbox{\includegraphics[scale=0.65]{../../../Assets/Grafici/LineeCodicePerMetodo.png}}
            \caption{Grafico per sprint di MPD14}
        \end{figure}
        ...
        \\\\
        \noindent \textbf{PB:} \\
        Nello sprint 7 il numero di linee di codice per metodo cresce circa a 5. Questo valore poi aumenta progressivamente: nello sprint 9 supera le 8 unità e nello sprint 10 si porta a 10. Questo andamento riflette la crescita della complessità dei metodi con l'evolversi del progetto. Tali valori restano sempre ben al di sotto delle soglie di accettabilità e ottimalità, indicando una buona gestione della dimensione dei metodi e una complessità contenuta. Il team ha consolidato questo andamento positivo monitorando attentamente la dimensione dei metodi nello sprint 11 e riuscendo a ridurre di una unità il numero medio di linee di codice per metodo.
