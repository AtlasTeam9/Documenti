...
\section{Introduzione}
    ...
    \section{Architettura}
        ...
        \subsection{Design Pattern utilizzati}
            ...
            \begin{itemize}
                \item \textbf{Strategy pattern}: utilizzato per la gestione dell'esportazione dei risultati dei test. È stata definita un'interfaccia che stabilisce il contratto per 
                    l'esportazione, mentre implementazioni concrete forniscono il supporto per i due formati decisi (PDF, CSV). Questo approccio consente di incapsulare algoritmi intercambiabili, 
                    favorendo l'estensione del sistema senza modificare il codice esistente e migliorando la separazione delle responsabilità;
                \item \textbf{Repository pattern}: utilizzato per astrarre la logica di accesso ai dati dalla business logic. BaseRepository definisce l'interfaccia astratta generica con i metodi 
                    ...
                    dettagli del file system e delega le operazione di I/O a FileStorage. Chi usa il repository non sa se i dati stanno su file, database o altro;
                ...
                \item \textbf{Facade pattern}: utilizzato nella gestione della Session. La classe Session infatti non gestisce direttamente nessuna logica, ma espone un'interfaccia unificata e 
